...
public class Ai {
	...
	public native void privateDestroy(int ptr);
	public native void toggleCallbacks(int ptr, int callbacks);
	
	private native void start(int ptr);
	private native void stop(int ptr);
	private native int move(int ptr, int moves[], int game, int level, int vct);
