...
import org.pente.gameServer.client.web.ImageUtils;
...
public class PlunkPenteBoardLW extends PenteBoardLW {
    ...
    public PlunkPenteBoardLW() {
        beveledEdge = 0;
        super.setGameName(null);
    }
    ...
    public void addNotify() {
        ...
        try {
            boardPic = ImageIO.read(new File("images/board1.jpg"));
        } catch (IOException i) {
            i.printStackTrace();
        }
    }
    ...
    protected void sizeChanged(int x, int y) {
        ...
        boardPicScaled = ImageUtils.getScaledInstance(boardPic, x, y,
                RenderingHints.VALUE_INTERPOLATION_BILINEAR, true);
        double borderPer = 110.0 / 1024.0;
        insets.left = insets.right = (int) (borderPer * x);
        insets.top = insets.bottom = (int) (borderPer * y);
    }

    private BufferedImage boardPic;
    private BufferedImage boardPicScaled;
    ...
    protected void drawEmptyBoardBackground(Graphics g) {
        ...
        g2.drawImage(boardPicScaled, 0, 0, this);
    }
