...
//        t.createNextRound();
    ...
    public List<Tourney> getUpcomingTournies() throws Throwable {
        ...
        List<Tourney> signup = new ArrayList<>();
    ...
    public List<Tourney> getCurrentTournies()
        ...
        PreparedStatement stmt = null;
        ResultSet result = null;
        List<Tourney> current = new ArrayList<>();
    ...
    public List<Tourney> getCompletedTournies() throws Throwable {
        ...
        PreparedStatement stmt = null;
        ResultSet result = null;
        List<Tourney> completed = new ArrayList<>();
...
//            }
    ...
    public Tourney getTourney(int eid)
        ...
        if (tourney != null) {
            ...
            Map<String, TourneyPlayerData> players = new HashMap<>();
            try {
                con = dbHandler.getConnection();
                stmt = con.prepareStatement(
