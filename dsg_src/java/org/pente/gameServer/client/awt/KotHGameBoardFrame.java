...
public class KotHGameBoardFrame extends Frame implements TableComponent,
    ActionListener {
    ...
    public KotHGameBoardFrame(final String host,
        ...
        playerList.addGetStatsListener(new PlayerActionAdapter() {
            public void actionRequested(String name) {
                new PlayerStatsDialog(KotHGameBoardFrame.this,
                    KotHGameBoardFrame.this.getLocationOnScreen(),
    ...
    public void actionPerformed(ActionEvent event) {
        if (event.getActionCommand().equals(PLAY)) {
            ...
            if (setTimeButton.isEnabled()) {
                new SetTimerDialog(
                    KotHGameBoardFrame.this,
                    setTimerListener,
                    KotHGameBoardFrame.this.gameStyle,
                    timed,
                    timerMinutes,
                    timerIncremental);
            }
            ...
            if (state != DSGGameStateTableEvent.NO_GAME_IN_PROGRESS &&
                ...
                resignDialog = DSGDialogFactory.createResignDialog(KotHGameBoardFrame.this, gameStyle);
            ...
            bootDialog = new BootDialog(
                KotHGameBoardFrame.this, gameStyle, bootList, 
            ...
            inviteDialog = new InviteDialog(KotHGameBoardFrame.this, gameStyle,
			...
			addAIDialog = new AddAIDialog(KotHGameBoardFrame.this, gameStyle,
				new ActionListener() {
            		...
            		middleSetDialog.addActionListener(new ActionListener() {
	            		public void actionPerformed(ActionEvent e) {
	            			if (e.getActionCommand().equals("Play")) {
	            				KotHGameBoardFrame.this.actionPerformed(e);
