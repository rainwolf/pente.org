...
public class InviteDialogTest {
	...
	public static void main(String[] args) throws Throwable {
		...
		playerList.setTableName("Invite Player");
        ...
        final InviteDialog d = new InviteDialog(
            f, gameStyle, 2, true, true, 1, 5, playerList, new PlayerActionAdapter() {
