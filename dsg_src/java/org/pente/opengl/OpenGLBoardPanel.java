...
//        drawEmptyBoardCoordinates(g);
    ...
    private void drawBoard3D(GL gl) {
        ...
        gl.glNormal3f(0, 0, 1);
        gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(-or, 0, 0);
        gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(-or, bor,  0);
        gl.glTexCoord2f(1.0f, repeatBorder); gl.glVertex3f(boardWidth + or,  bor, 0);
        gl.glTexCoord2f(0.0f, repeatBorder); gl.glVertex3f(boardWidth + or, 0, 0);
        gl.glEnd();
        
	    gl.glBegin(GL.GL_QUADS);
        gl.glNormal3f(0, 1, 0);
        gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(-or, bor, 0);
        gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(-or, bor,  or);
        gl.glTexCoord2f(1.0f, repeatBorder); gl.glVertex3f(boardWidth + or,  bor, or);
        gl.glTexCoord2f(0.0f, repeatBorder); gl.glVertex3f(boardWidth + or, bor, 0);
        gl.glEnd();

	    gl.glBegin(GL.GL_QUADS);
        gl.glNormal3f(0, 0, 1);
        gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(-or, bor, or);
        gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(-or, -or,  or);
        gl.glTexCoord2f(1.0f, repeatBorder); gl.glVertex3f(boardWidth + or,  -or, or);
        gl.glTexCoord2f(0.0f, repeatBorder); gl.glVertex3f(boardWidth + or, bor, or);
        gl.glEnd();
        ...
        gl.glTexCoord2f(0.0f, repeatBorder); gl.glVertex3f(0, 0, -boardHeight);
        gl.glTexCoord2f(1.0f, repeatBorder); gl.glVertex3f(0, bor, -boardHeight);
        gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(0, bor,  0);
	    ...
	    gl.glBegin(GL.GL_QUADS);
        gl.glNormal3f(0, 1, 0);
        gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(0, bor, 0);
        gl.glTexCoord2f(0.0f, repeatBorder); gl.glVertex3f(0, bor, -boardHeight);
        gl.glTexCoord2f(1.0f, repeatBorder); gl.glVertex3f(-or, bor, -boardHeight);
        gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(-or, bor, 0);
        ...
        gl.glNormal3f(-1, 0, 0);
        gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(-or, bor, or);
        gl.glTexCoord2f(0.0f, repeatBorder); gl.glVertex3f(-or, bor, -boardHeight - or);
        gl.glTexCoord2f(1.0f, repeatBorder); gl.glVertex3f(-or, -or, -boardHeight - or);
        gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(-or, -or, or);
        gl.glEnd();
	    ...
	    gl.glBegin(GL.GL_QUADS);
        gl.glNormal3f(0, 0, 1);
        gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(0, 0, -boardHeight);
        gl.glTexCoord2f(0.0f, repeatBorder); gl.glVertex3f(boardWidth, 0, -boardHeight);
        gl.glTexCoord2f(1.0f, repeatBorder); gl.glVertex3f(boardWidth, bor, -boardHeight);
        gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(0, bor,  -boardHeight);
        gl.glEnd();

	    gl.glBegin(GL.GL_QUADS);
        gl.glNormal3f(0, 1, 0);
        gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(-or, bor, -boardHeight);
        gl.glTexCoord2f(0.0f, repeatBorder); gl.glVertex3f(boardWidth + or, bor, -boardHeight);
        gl.glTexCoord2f(1.0f, repeatBorder); gl.glVertex3f(boardWidth + or, bor, -boardHeight - or);
        gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(-or, bor, -boardHeight - or);
        gl.glEnd();

	    gl.glBegin(GL.GL_QUADS);
        gl.glNormal3f(0, 0, -1);
        gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(-or, bor, -boardHeight - or);
        gl.glTexCoord2f(0.0f, repeatBorder); gl.glVertex3f(boardWidth + or, bor, -boardHeight - or);
        gl.glTexCoord2f(1.0f, repeatBorder); gl.glVertex3f(boardWidth + or, -or, -boardHeight - or);
        gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(-or, -or, -boardHeight - or);
        gl.glEnd();
	    ...
	    gl.glBegin(GL.GL_QUADS);
        gl.glNormal3f(-1, 0, 0);
        gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(boardWidth, 0, 0);
        gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(boardWidth, bor,  0);
        gl.glTexCoord2f(1.0f, repeatBorder); gl.glVertex3f(boardWidth, bor, -boardHeight);
        gl.glTexCoord2f(0.0f, repeatBorder); gl.glVertex3f(boardWidth, 0, -boardHeight);
        gl.glEnd();
	    ...
	    gl.glBegin(GL.GL_QUADS);
        gl.glNormal3f(0, 1, 0);
        gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(boardWidth, bor, 0);
        gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(boardWidth + or, bor, 0);
        gl.glTexCoord2f(1.0f, repeatBorder); gl.glVertex3f(boardWidth + or, bor, -boardHeight);
        gl.glTexCoord2f(0.0f, repeatBorder); gl.glVertex3f(boardWidth, bor, -boardHeight);
        gl.glEnd();

	    gl.glBegin(GL.GL_QUADS);
        gl.glNormal3f(1, 0, 0);
        gl.glTexCoord2f(0.0f, 0.0f); gl.glVertex3f(boardWidth + or, bor, or);
        gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex3f(boardWidth + or, -or, or);
        gl.glTexCoord2f(1.0f, repeatBorder); gl.glVertex3f(boardWidth + or, -or, -boardHeight - or);
        gl.glTexCoord2f(0.0f, repeatBorder); gl.glVertex3f(boardWidth + or, bor, -boardHeight - or);
        gl.glEnd();
