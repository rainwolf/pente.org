 ...
 * Signature: ()V
 */
JNIEXPORT jint JNICALL Java_org_pente_mmai_Ai_init
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_pente_mmai_Ai_privateDestroy(JNIEnv *env, jobject o, jint ptr)
{
	CAi* cai=(CAi*)ptr;
    cai->CAi::~CAi();
    printf("c destroyed\n");
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_pente_mmai_Ai_stop(JNIEnv *env, jobject o, jint ptr)
{
   CAi* cai=(CAi*)ptr;
   cai->stopped = 1;
}
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_pente_mmai_Ai_toggleCallbacks(JNIEnv *env, jobject o, jint ptr, jint callbacks)
{
   CAi* cai=(CAi*)ptr;
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_pente_mmai_Ai_start(JNIEnv *env, jobject o, jint ptr)
{
   CAi* cai=(CAi*)ptr;
   cai->stopped = 0;
}
...
JNIEXPORT jint JNICALL Java_org_pente_mmai_Ai_move(JNIEnv *env, jobject obj, 
	jint ptr, jintArray movesArr, jint game, jint level, jint vct)
{
    CAi* cai=(CAi*)ptr;
