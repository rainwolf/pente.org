<font face="Verdana, Arial, Helvetica, sans-serif" size="2">
   ...
   start with player 1's first move in the middle of the board, except for Go, D-Pente,
   and DK-Pente. Play then continues
   ...
   G-Pente is a variation of Pente proposed by Gary Barnes. Again the reason for the variation is to make the game more
   fair
   ...
   For example, when black plays into the opening of the line of stones, the 2 white stones on the right will be
   captured, and the 2 black stones on the left will be poofed.
   <br>
   <br>
   ...
   The rules of Go are a bit involved but a nice interactive tutorial can be found <a
   href="https://online-go.com/learn-to-play-go">here</a>.
   <br>
   Here at pente.org we use a komi of 7.5 for all board sizes. Play continues until both players pass consecutively.
   After which the first
   player to pass gets to mark dead stones (stones of both sides they believe would have been captured eventually), and
   then the other player gets to accept the assessment of dead stones or reject it. In case of rejection,
