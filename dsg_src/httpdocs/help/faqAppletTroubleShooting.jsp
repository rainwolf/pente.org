<%@ page import="java.util.*, org.pente.gameServer.core.*, 
...
<ol>
  ...
  <li>For the Internet Zone, be sure that the Security level is set to "Medium" or below. (If you have chosen to customize your Security settings for the Internet zone, be sure that under the Java heading, "Java permissions" is not set to "Disable Java." You will want to select one of the three safety levels instead. Also be sure that under the Scripting heading, "Scripting of Java Applets" is set to "Enable" or "Prompt.")
  <li>Next, click the "Advanced" tab.
  <li>Scroll down until you see the sub heading "Java VM."
  <li>Check the boxes next to "Java logging enabled" and "Java console enabled." (Note: If you have checked the box next to "Java JIT compiler enabled" and are experiencing freezing problems, uncheck that box.)
</ol>

<b>Internet Explorer 5.XX or 6.XX for Windows</b>
<ol>
  <li>Click "Tools" in the menu bar, and then select "Internet Options."
  <li>Click the "Security" tab. For the Internet zone, be sure that the Security level is set to "Medium" or below. (If you have chosen to customize your security settings for the Internet zone, be sure that under the Java heading, "Java permissions" is not set to "Disable Java." You will want to select one of the three safety levels instead. Also be sure that under the Scripting heading, "Scripting of Java Applets" is set to "Enable" or "Prompt.")
  <li>Next, click the "Advanced" tab.
  <li>Scroll down until you see the sub heading "Java VM." 
  <li>Check the boxes next to "Java logging enabled" and "Java console enabled." (Note: If you checked the box next to "Java JIT compiler enabled" and are experiencing freezing problems, uncheck that box.)
</ol>

<b>Note to Windows XP users</b><br>
By default, the Windows XP operating system comes with the Internet Explorer 6 browser without the Java Virtual Machine (JVM) installed, which is required to run Java programs such as the Pente.org game room.<br>
<br>
If you install Windows XP over an existing installation of Windows that already has Internet Explorer with a JVM installed, then you should be able to play justs fine. <br>
<br>
At this time Microsoft no longer provides a download of the JVM if you do not already have it installed. You are welcome to contact them for information on where to find and download this program. <br>
<br>
...
You may experience difficulties with older browsers. If you are using Internet Explorer 3.xx or lower or Netscape 3.xx or lower, please upgrade your browser to a newer version.<br>
<br>
<b>Windows 3.1, Dreamcast, and WebTV</b><br>
Windows 3.1, Dreamcast, and WebTV (or other Web appliances) do not support the Java necessary to run the Pente.org game room.<br>
<br>
<b>Using AOL?</b><br>
If you're using AOL, CompuServe, or Prodigy, Pente.org should work just fine if you upgrade to the most current version of your online service and upgrade your external browser to Netscape 4.XX or Microsoft Internet Explorer 4.XX. After connecting to your online service, minimize the window and then launch your external browser (Netscape or Internet Explorer). <br>
<br>
...
On OS 8-9, Pente.org work best on a Macintosh using the Macintosh OS Runtime for Java (MRJ). Currently, the only browser which supports the MRJ is Microsoft Internet Explorer.<br>
<br>
...
<br>
If you are having problems with the browser (we recommend 4.5 or newer), make sure you are using the most current MRJ: <br>
<a href="http://www.apple.com/java">http://www.apple.com/java</a><br>
<br>
If you are having problems with OS X, please make sure you are using the most current versions of OS X and Internet Explorer. If you continue having problems, you may want to boot in classic mode and use IE 4.5 or 5 or Netscape 4 which work very well with OS 8-9. <br>
<br>
