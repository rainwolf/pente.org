...
%>
<div id="intro">
   <h6><span><%= numberFormat.format(siteStatsData.getNumPlayers()) %></span> players,
      <span><%= numberFormat.format(siteStatsData.getNumGames()) %></span> games, <span><%= onlinePlayers %></span>
      players online now.</h6>
</div>