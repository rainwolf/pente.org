...
<div class="pagebody">
   ...
   <div style="float:left;width:760px">
      ...
      <div id="text">
         ...
         play against a powerful computer opponent, learn strategy, play in tournaments and more. See our <b><a
         href="/features.jsp">features</a></b>.<br>
         <br>
         Pente is a fun board game that is easy to learn. Anyone can figure it out and play a game in five minutes at
         pente.org.<br>
      ...
      <div id="right">
         ...
         <div style="padding:10px;border: 1px solid gray">
            ...
            <p style="font-size:14px">Play Pente from your mobile phone! <br/><br/><a
               href="https://itunes.apple.com/us/app/pente-live/id595426592?mt=8">Learn how</a>.</p>
         </div>
      </div>
