...
<div id="features" class="pagebody">
   ...
   <div id="features-livegame">
      <h3>Play live games</h3>
      <p>The main point of the site is to be able to play live Pente games with
   ...
   <div id="features-tbgame">
      <h3>Play turn-based games</h3>
      <p>If you don't have a block of time for
   ...
   <div style="clear:both">
      ...
      <div id="features-apps">
         <h3>Mobile Apps</a></h3>
         <p> Not always in front of your computer? Play from anywhere, any time with out mobile apps for iOS and
            Android. Our apps support all website features: turn-based play, live play, access the game database, play 2
            different computer players.
            <br>
            <br>
         <center>
            <a href="https://itunes.apple.com/us/app/pente-live/id595426592?ls=1&mt=8" target="mobileApp"><img
               src="gameServer/images/app_store.png"></a>
            <a href="https://play.google.com/store/apps/details?id=be.submanifold.pentelive" target="mobileApp"><img
               src="gameServer/images/google_play.png"></a>
         </center>
      ...
      <div id="features-competition">
         ...
         <p> We have regular tournaments where you can battle for eternal glory and a crown. And King of the Hill where
            you fight your way to the top of the hill for a well-earned crown.
            <br>
   ...
   <div style="clear:both">
      <div id="features-stats">
         <h3>Stats and Rankings</h3>
         <p>We keep track of your ratings over time
      ...
      <div id="features-database">
         <h3>Game Database</h3>
         <p>Want to really improve your game? Study past
