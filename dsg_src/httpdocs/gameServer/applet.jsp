<%@ page import="org.pente.gameServer.client.web.*, java.io.*,
...
<body bgcolor="<%= appletBack %>" text="<%= appletFore %>" link="<%= appletFore %>" topmargin="0" leftmargin="0" marginwidth="0" marginheight="0">
 ...
 <tr>
   ...
   <td width="470" valign="bottom">
      <font size="2" face="Verdana, Arial, Helvetica, sans-serif">
        Welcome, <b><%=displayName %></b>.  The game room is large
