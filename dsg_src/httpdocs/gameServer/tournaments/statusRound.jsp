...
<%
   ...
   String gameName = GridStateFactory.getGameName(tourney.getGame());
      ...
      <td colspan="2">
         <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
            ...
            <a href="statusRound.jsp?eid=<%= eidStr %>&round=<%= otherRound.getRound() %>">
               Round <%= otherRound.getRound() %>
            </a> (<%= otherRound.getNumSections() %> Sections, <%= otherRound.getNumPlayers() %> Players)<br>
            <% } else { %>
