...
<%@ page import="org.pente.database.DBUtil" %>
   ...
   <tr>
      <td colspan="2">
         <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
            ...
            <b><a href="javascript:submitToDatabase('Pente.org', 'Tournament 5A', 'All Rounds', 'All Sections');">View
               Section A Games</a></b><br>
            <b><a href="javascript:submitToDatabase('Pente.org', 'Tournament 5B', 'All Rounds', 'All Sections');">View
   ...
   <tr>
      <td width="100%">
         ...
         <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
            ...
            &nbsp;&nbsp;<b><a href="#tournament5A-<%= currentRound %>">Round <%= currentRound %>
         </a></b><br>
            <% }
            } %>
            ...
            <% currentRound = 0;
               for (int i = 0; i < tournament5BData.size(); i++) {
                  ...
                  if (d.round != currentRound) {
                     currentRound = d.round; %>
            &nbsp;&nbsp;<b><a href="#tournament5B-<%= currentRound %>">Round <%= currentRound %>
         </a></b><br>
            <% }
            } %>
            ...
            <tr bgcolor="<%= bgColor1 %>">
               <td colspan="4">
                  <font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="white">
                     <a name="tournament5A-<%= currentRound %>"><b>Round <%= currentRound %>
                     </b>
                  </font>
               </td>
            </tr>
      ...
      <td width="100%">
         <table width="95%" align="center" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr bgcolor="<%= bgColor1 %>">
               <td colspan="4">
                  <font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="white">
                     <a name="tournament5B-<%= currentRound %>"><b>Round <%= currentRound %>
                     </b>
                  </font>
               </td>
            </tr>
