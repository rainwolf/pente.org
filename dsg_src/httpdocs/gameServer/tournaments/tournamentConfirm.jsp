...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
   ...
   <tr>
      <td colspan="2">
         ...
         <form method="post" action="tournamentSignup.jsp">
            ...
            You are going to sign-up with the name <b><font color="red"><%= name %>
         </font></b>,
            ...
            %>
            <font color="red"><b>
               Before you can sign up for this tournament, you have to play at least 1 rated set
               of <%= GridStateFactory.getDisplayName(tourney.getGame()) %>.
            </b></font><br><br>
            ...
            (<font color="red"><%= dsgPlayerData.getEmail() %>
         </font>).
 ...
 margin-bottom:10px; background:#fffbcc; border:1px solid #e6db55; padding:5px; font-weight:bold; width:100%;color:red;">
               ...
               Note: This tournament has VERY different rules/procedures from past tournaments at pente.org, <br>you <b>MUST
               <a href="/help/helpWindow.jsp?file=tourneySeventh-Heaven">read these new rules</a></b> and understand
               them prior to signing up.
            </div>
            <% } else { %>
   ...
   <tr>
      <td colspan="2">
         <h3><%= tournamentPlayers.size() %> Players signed up for <%= tourney.getName() %>
         </h3>
