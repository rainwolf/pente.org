...
<br>
<br>
<u><b>Note:</b></u> The upgrade of your account should happen "near"-instantaneous after payment, if that does not happen within a few minutes, then
<a href="http://www.pente.org/gameServer/newMessage.jsp?to=rainwolf">message</a> me and I will look into it asap.
<br>
<br>
 ...
 -->
   <tr>
      <td align="left">
         ...
         <br> These vacation days do <b><font color="red">not</font></b> roll over
         to <%=Calendar.getInstance().get(Calendar.YEAR) + 1%>.
      </td>
      <td align="center" colspan="2">
         ...
         <% } else { %>
         <font color="red">Sorry, you can't purchase extra vacation while participating in an ongoing tournament that
            allows vacation time.</font>
         <% } %>
      </td>
   </tr>
   <!-- <tr>
   ...
   <tr>
      ...
      <td align="center">
         <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" target="_top">
            ...
            <input type="hidden" name="custom" value="<%=gifter + ";" + giftee%>"/>
            <input type="image" src="https://www.sandbox.paypal.com/en_US/i/btn/btn_buynow_SM.gif" border="0"
                   name="submit" alt="PayPal - The safer, easier way to pay online!">
...
<table border="0" cellpadding="0" cellspacing="2" width="100%">
   <tr>
      <td valign="top">
         ...
         Pente.org used to be supported by ads and donations. Below is the list of people who voluntarily donated and
         supported pente.org over the years. Donating is still possible and will add you to the list below, but it is
         separate from the abovementioned subscriptions and benefits.
         <br>
         <br>
         You can make your donations using
         <b><a href="javascript:document.paypal_form.submit()">paypal</a></b>, make sure to communicate your <font
         color="red">username</font> when you donate.<br>
         <b><font color="red">Note: </font></b> This donation will make your name show up in the list of donors below,
         but it is <b>not</b> a subscription fee. To become a subscriber and get
   ...
   <tr>
      ...
      <td>
         <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
            <a href="/gameServer/profile?viewName=<%= d.getName() %>"><%= d.getName() %>
            </a>
         </font>
      </td>
      <% } %>
