...
<form enctype="multipart/form-data"
   ...
   <table width="100%" border="0" colspacing="0" colpadding="0">
     ...
     width:90%;">
               ...
               %>
               You have unlimited turn-based
               games<%=dsgPlayerData.databaseAccess() ? ", database access" : ""%><%=dsgPlayerData.showAds() ? " but you will get advertisements" : ", and you will not see advertisements"%>
               .<br>
               Your subscription ends
               on <%=dsgPlayerData.hasPlayerDonated() ? "" + profileDateFormat.format(dsgPlayerData.getSubscriptionExpiration()) : ""%>
               .
...
//              if (b.length() < 2) b = "0"+b;
                     ...
                     %>
                     <input type="text" size="6" maxlength="6" name="changeNameColor"
                            value="<%= nameColor %>" <%= disabled %>>
                     <br>
               ...
               <tr>
                  <td><a name="picture"><h4>Picture</h4></a></td>
               </tr>
               <tr>
                  <td valign="top">
                     <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
               ...
               <tr>
                  <td><a name="note"><h4>Note</h4></a></td>
               </tr>
               <tr>
                  <td>
                     <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
