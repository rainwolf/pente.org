   ...
   <tr>
      <td>
         ...
         <form name="reply_undo_form" method="post"
            ...
            <br>
            <br>
            <button type="submit" name="command" value="acceptUndo"
                    style="background-color:#4CAF50;color: white;font-size: 16px;padding: 5px 15px;"> accept undo
            </button>
            <button type="submit" name="command" value="declineUndo"
                    style="background-color:#f44336;color: white;font-size: 16px;padding: 5px 15px;"> decline undo
            </button>
