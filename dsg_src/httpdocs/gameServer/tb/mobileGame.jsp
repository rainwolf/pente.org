...
<br>
<br>
This is beta, preliminary support for android devices and others that can't handle Java. 
        <ul>
          ...
          <li>In-game messages (viewing and sending) is more or less supported.
          </li>
