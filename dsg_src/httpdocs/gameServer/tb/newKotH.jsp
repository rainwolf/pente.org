...
<table align="left" width="100%" border="0" colspacing="1" colpadding="1">
   ...
   <tr>
      <td>
         ...
         King of the Hill games are always rated, and the player name or game cannot be changed here anymore. Please
         select a timeout for your game and send the invitation.
         <br>
         <br>
