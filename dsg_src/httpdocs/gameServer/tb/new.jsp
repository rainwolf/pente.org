...
<table align="left" width="100%" border="0" colspacing="1" colpadding="1">
   ...
   <tr>
      <td>
         ...
         <br>
         <font color="red"><b>New: </b></font>Beginner invitations, just like regular ones, except that when your
         opponent accepts such an invitation, the server will post an identical one in their name
         <br>
         &nbsp
         <br>
      </td>
   ...
   <tr>
      <td>
         <div align="left"
              style="position:relative;font-weight:bold;border:2px <%= textColor2 %> solid; background:#ffd0a7">
            You have reached the limit of games you can play simultaneously on a free account. You can only send open
            invitations until you finish some games.
         ...
         <form name="new_game_form" method="post"
            ...
            for (int i = 0; i < games.length; i++) { %>
                           <option <%=(tbGame == games[i].getId() ? "selected" : "")%>
                              value="<%= games[i].getId() %>"><%= games[i].getName() %>
                           </option>
                           <%--
                  ...
                  <td>
                     <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
                        <select name="invitationRestriction" size="1">
                           ...
                           <option <%= ("N".equals(tbRestriction) ? "selected" : "") %> value="N">Not already playing
                           </option>
                           ...
                           <option <%= ("S".equals(tbRestriction) ? "selected" : "") %> value="S">Similar rating
                              (&plusmn 100)
                           </option>
                           <option <%= ("C".equals(tbRestriction) ? "selected" : "") %> value="C">Same rating class
                           </option>
                        </select>
               ...
               <tr>
                  <td colspan="2">
                     <label><input id="remember" name="remember" type="checkbox" value="yes"/> remember my settings
                     </label>
                  </td>
               </tr>
            </table>
            ...
            <a class="boldbuttons" href="javascript: submitnewgameform()"
               style="margin-right:6px; margin-left: 6px"><span>Create Game Invitation</span></a>
