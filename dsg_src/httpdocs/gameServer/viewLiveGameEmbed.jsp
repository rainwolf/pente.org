                  ...
                  <table align="right" border=1 width="250px">
                     ...
                     <tr>
                        ...
                        <td width="45%" align="center">
                           <b><%=game.getPlayer1Data().getUserIDName()%>
                           </b>
                        </td>
                        <td align="center" bgcolor="#000000">
                           <b><font color="white"><%=game.getPlayer2Data().getUserIDName()%>
                           </font>
                           </b>
                        </td>
                     </tr>
    ...
    %>
         ...
         <table align="right" border=1 width="250px">
            ...
            <tr>
               ...
               <td>
                  <% PlayerData d = game.getPlayer1Data(); %>
                  <%@include file="vgplayerLink.jspf" %> &nbsp;<%= d.getRating()  %>
