   ...
   <script type="text/javascript">
      ...
      function sensePage() {
         if (!document.getElementById('aswift_0')) {
            ...
            document.getElementById('bannerAd').setAttribute("style", "width:468px; height:60px;");
         }
      }
...
<div id="senseReplace" style="width:468px;height:60px;" top="50%"></div>
<div id="bannerAd" style="width:468px;height:60px;">
   <script type="text/javascript"><!--
   google_ad_client = "ca-pub-3326997956703582";
   /* penteORG2 */
   google_ad_slot = "7073452247";
   google_ad_width = 468;
   google_ad_height = 60;
   //-->
   </script>
