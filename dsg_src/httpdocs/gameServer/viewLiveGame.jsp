   ...
   <tr>
      <td>
         <object
            ...
            <param name="player1RatingGif"
                   value="<%= SimpleDSGPlayerGameData.getRatingsGifRatingOnly(game.getPlayer1Data().getRating()) %>">
            <param name="player2" value="<%= game.getPlayer2Data().getUserIDName() %>">
            <param name="player2Rating" value="<%= game.getPlayer2Data().getRating() %>">
            <param name="player2RatingGif"
                   value="<%= SimpleDSGPlayerGameData.getRatingsGifRatingOnly(game.getPlayer2Data().getRating()) %>">
