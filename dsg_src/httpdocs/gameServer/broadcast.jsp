   ...
   <tr>
      <td>
         ...
         <div align="left"
            ...
            Here you can send an alert to your followers or friends (followers who follow you back) and let them know
            you are available to play in the live game room.
            All your recipients receive a message (from you), and players with the penteLive mobile app receive a
            special notification.
            <br>
            <br>
            Players' profiles are equipped with a follow button where you can add that player to your following list.
            The list of people you follow and are following you is
            available in your profile. Once you follow a player, the follow button changes into an unfollow button that
            you can use to undo your mistake.
            <br>
      ...
      <td>
         ...
         <form name="broadcast_form" method="post"
            ...
            if (games[i].getId() > 50) continue;%>
                           <option
                              value="<%= GridStateFactory.getDisplayName(games[i].getId()) %>"><%= GridStateFactory.getDisplayName(games[i].getId()) %>
                           </option>
                              <% } %>
                     </font>
