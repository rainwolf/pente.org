...
<form name="addTourney" action="newTourney.jsp" method="post">
   ...
   <table border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
         <td valign="top"><b>Initial time: (Minutes for live, days for TB) </b></td>
         <td><input type="text" maxLength="3" size="3" name="initial"></td>
      </tr>
      <tr>
         <td valign="top"><b>Incremental time: (any value for TB, will be ignored)</b></td>
         <td><input type="text" maxLength="3" size="3" name="incremental"></td>
      </tr>
      <tr>
         <td valign="top"><b>Rating restriction:</b></td>
      ...
      <tr>
         <td valign="top"><b>Directors:</b><br>(comma-delimited names)</td>
         <td>
