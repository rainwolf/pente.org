...
<table border="1">
   ...
   <tr>
      <td>Sets Created</td>
      <td><%= cacheStats.getSetsCreated() %>
      </td>
   </tr>
   <tr>
      <td>Sets Completed</td>
      <td><%= cacheStats.getSetsCompleted() %>
      </td>
   </tr>
   <tr>
      <td>Games Created</td>
      <td><%= cacheStats.getGamesCreated() %>
      </td>
   </tr>
   <tr>
      <td>Games Completed</td>
      <td><%= cacheStats.getGamesCompleted() %>
      </td>
   </tr>
   <tr>
      <td>Moves Made</td>
      <td><%= cacheStats.getMovesMade() %>
      </td>
   </tr>
   <tr>
      <td>Sets Cached</td>
      <td><%= cacheStats.getSetsCached() %>
      </td>
   </tr>
   <tr>
      <td>Sets Uncached</td>
      <td><%= cacheStats.getSetsUncached() %>
      </td>
   </tr>
   <tr>
      <td>Games Cached</td>
      <td><%= cacheStats.getGamesCached() %>
      </td>
   </tr>
   <tr>
      <td>Games Uncached</td>
      <td><%= cacheStats.getGamesUncached() %>
      </td>
   </tr>
   <tr>
   ...
   <tr>
      ...
      <td><%= cacheStats.getGameLoadsCached() %>
         / <%= cacheStats.getGameLoads() %> <%= cacheStats.getGameLoadHitRate() %>
   </tr>
