...
<div>
   ...
   <div
      style="float:left;width:650px;clear:both;border-top:1px solid gray;margin-top:10px;padding-top:10px;padding-bottom:10px;">
...
<h4 style="clear:both;border-top:1px solid gray;padding-top:20px;">Post an applet that can display the sequence of moves
   in a game</h4>
...
<div style="width:700px;margin-top:10px;padding:10px;padding-top:0px;padding-left:20px;">
   ...
   <div style="float:left;width:770px;">
      <iframe src="/gameServer/viewGameEmbed.jsp?g=Pente&m=K10,L11&bn=dweebo&wn=peter&w=700&h=260" width=770 height=600
...
<div
   style="float:left;width:800px;clear:both;border-top:1px solid gray;margin-top:10px;padding-top:10px;padding-bottom:10px;">
   If you want to display a game that was either played here at pente.org or is in
   the <a href="/gameServer/controller/search?quick_start=1">pente game database</a> you
   can just specify the unique game ID.
</div>
...
<div style="width:770px;margin-top:10px;padding:10px;padding-left:20px;">
   <div style="float:left;width:770px;">
      <iframe src="/gameServer/viewLiveGame?g=34194139852955&e=1&w=770&h=360" width=770 height=600 frameborder=0
