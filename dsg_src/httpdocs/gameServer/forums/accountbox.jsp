...
<table class="jive-box" cellpadding="3" cellspacing="0" border="0" width="200">
    <tr>
        <td width="1%"><a href="settings!default.jspa"><img src="images/settings-16x16.gif" width="16" height="16"
                                                            border="0"></a></td>
        <td width="99%">
            <%-- Your Control Panel --%>
    ...
    <tr>
        <td width="1%"><a href="settings!default.jspa"><img src="images/watch-16x16.gif" width="16" height="16"
                                                            border="0"></a></td>
        <td width="99%">
            <%-- Watches --%>
