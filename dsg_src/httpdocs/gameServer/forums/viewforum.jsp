   ...
   <tr valign="top">
      ...
      <td width="1%">
		...
		<table class="jive-box" cellpadding="3" cellspacing="0" border="0" width="200">
		  <tr>
		    <td width="1%"><a href="/rss.xml?forumID=<%= forum.getID() %>"><img src="/gameServer/images/feed.png"
                                                                              border="0" width="16"
                                                                              height="16"></a></td>
            <td width="99%">
...
<tr>
    ...
    <td>
        ...
        <tr>
            <td><a href="post!default.jspa?forumID=<%= forum.getID() %>"><img src="images/post-16x16.gif" width="16"
    ...
    <td>
        ...
        <tr>
            <td><a href="search!default.jspa?forumID=<%= forum.getID() %>"><img src="images/search-16x16.gif" width="16"
                                                                                height="16" border="0"></a></td>
            <td>
                <span class="jive-button-label">
                <%-- Search Forum --%>
    ...
    <ww:if test="pageUser">
       <jive:property if="watches.enabled">
            <td>
                <table cellpadding="3" cellspacing="2" border="0">
                <tr>
                    <td><a href="watches.jspa?forumID=<%= forum.getID() %>"><img src="images/watch-16x16.gif" width="16"
                                                                                 height="16" border="0"></a></td>
                    <td>
                        <span class="jive-button-label">
