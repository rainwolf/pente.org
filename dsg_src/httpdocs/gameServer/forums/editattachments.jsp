...
<ww:else>
    ...
    <ww:iterator value="message/attachments" status="'status'">
        ...
        <tr class="<ww:if test="@status/odd==true">jive-odd</ww:if><ww:else>jive-even</ww:else>">
            ...
            <td>
                <img src="<%= request.getContextPath() %>/servlet/JiveServlet?attachImage=true&contentType=<ww:property value="contentType" />&attachment=<ww:property value="ID" />" border="0">
            </td>
            <td>
