            ...
            <tr>
               <td colspan="2">
                    ...
                    <tr>
                        <td width="1%"
                        ><a
                           href="<%= request.getContextPath() %>/servlet/JiveServlet/download/<%= forum.getID() %>-<%= thread.getID() %>-<%= message.getID() %>-<%= attachment.getID() %>/<%= attachment.getName() %>"
                        ><img
                           src="<%= request.getContextPath() %>/servlet/JiveServlet?attachImage=true&contentType=<%= java.net.URLEncoder.encode(attachment.getContentType()) %>&attachment=<%= attachment.getID() %>"
                           border="0"></a
                        ></td>
                        <td width="98%">
