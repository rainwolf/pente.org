...
<ww:if test="pageUser">
    ...
    <%  tabs = new String[][] {
        ...
        subtabs = new String[][][] {
            ...
            new String[][] {{""},{""}},
            new String[][] {{""},{""}},
            new String[][] {{act.getText("settings.viewing_prefs"), "#viewing"},
                            /* Watch Settigns */
                            {act.getText("settings.watch"), "#watch"}},
                            /* Personal Inforamtion */
            new String[][] {/* Forums */
                            {act.getText("global.forums"), "#forums"},
                            /* Topics */
                            {act.getText("global.topics"), "#topics"}}
        };
    %>
...
<ww:else>
    ...
    <%  tabs = new String[][] {
            /* General Settings */
            {act.getText("global.general_settings"), "settings!default.jspa"}
        };
        subtabs = new String[][][] {
            /* Viewing Preferences */
            new String[][] {{act.getText("settings.viewing_prefs"), "#viewing"}}
...
<tr>
    <td class="jive-tab-spacer" width="1%"><img src="/gameServer/forums/images/blank.gif" width="10" height="1" border="0"></td>

    <%  int selectedTabIndex = 0;
        for (int i=0; i<tabs.length; i++) {
            boolean selected = selectedTab.equals(tabs[i][0]);
            if (selected) { selectedTabIndex = i; }
    %>

        <td class="jive-<%= (selected?"selected-":"") %>tab" width="1%" nowrap>
            <a href="<%= tabs[i][1] %>"><%= tabs[i][0] %></a>
        </td>
        <td class="jive-tab-spacer" width="1%"><img src="/gameServer/forums/images/blank.gif" width="10" height="1" border="0"></td>
...
<tr><td><img src="/gameServer/forums/images/blank.gif" width="1" height="1" border="0"></td></tr>
</table>
