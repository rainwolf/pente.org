...
<font size="-1"><b>Extended Properties for <i><%= user.getUsername() %></i></b></font>
<ul>
...
<tr bgcolor="#ffffff">
    ...
    <td align="center"><a href="editUserProps.jsp?user=<%= userID %>&delete=true&propName=<%= propertyName %>"
