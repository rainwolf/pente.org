         ...
         <table cellpadding="2" cellspacing="0" border="0" width="200">
            <tr><%  for (int i=0; i<depth; i++) { %>
               ...
               <td width="<%= (100-depth) %>%">
                  <% } %>
                  <font size="-1" face="arial">
                     <b><a href="forums.jsp?cat=<%= subCat.getID() %>"><%= subCat.getName() %>
                     </a></b>
                  </font></td>
      </td>
   </tr>
                              ...
                              <table cellpadding="0" cellspacing="0" border="0">
                                 <tr>
                                    <td>
                                       ...
                                       ><img src="images/arrow_up.gif" width="13" height="9" border="0" vspace="2"
                                             hspace="2"></a>
                                       <% } else { %>
                                       <img src="images/blank.gif" width="13" height="9" border="0" vspace="2"
                                            hspace="2">
                                       <% } %>
                                    </td>
                                    <td>
                                       ...
                                       ><img src="images/arrow_down.gif" width="13" height="9" border="0" vspace="2"
                                             hspace="2"></a>
                                       <% } else { %>
                                       <img src="images/blank.gif" width="13" height="9" border="0" vspace="2"
                                            hspace="2">
