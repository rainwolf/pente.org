...
<font size="-1"><b>Extended Properties for group <i><%= group.getName() %></i></b></font>
<ul>
...
<tr bgcolor="#ffffff">
    ...
    <td align="center"><a href="editGroupProps.jsp?group=<%= groupID %>&delete=true&propName=<%= propertyName %>"
