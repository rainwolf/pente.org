                     ...
                     <tr>
                        <td nowrap align="center">
                           <font size="-2" face="verdana">
                              ...
                              <% if (isLocalMember) { %>
                           ><b><%= member.getAddress().getHostName() %>
                           </b></a>]
                              <% } else { %>
               ...
               <tr bgcolor="#ffffff">
                  <td align="center"<%= (cacheEnabled) ? " bgcolor=\"#99cc99\"" : "" %>>
                     <font size="-1">
                        ...
                        <label for="rb01"><%= (cacheEnabled) ? "<b>On</b>" : "On" %>
                        </label>
                     </font>
                  </td>
                  <td align="center"<%= (!cacheEnabled) ? " bgcolor=\"#cc6666\"" : "" %>>
                     <font size="-1">
                        <input type="radio" name="cacheEnabled" value="false" id="rb02"
                           <%= (!cacheEnabled)?"checked":"" %>>
                        <label for="rb02"><%= (!cacheEnabled) ? "<b>Off</b>" : "Off" %>
                        </label>
                     </font>
                  </td>
                  <td align="center">
                  ...
                  <td align="center"<%= (stqcEnabled) ? " bgcolor=\"#99cc99\"" : "" %>>
                     <font size="-1">
                        <input type="radio" name="stqcEnabled" value="true" id="rb03"
                           <%= (stqcEnabled)?"checked":"" %>>
                        <label for="rb03"><%= (stqcEnabled) ? "<b>On</b>" : "On" %>
                        </label>
                     </font>
                  </td>
                  <td align="center"<%= (!stqcEnabled) ? " bgcolor=\"#cc6666\"" : "" %>>
                     <font size="-1">
                        <input type="radio" name="stqcEnabled" value="false" id="rb04"
                           <%= (!stqcEnabled)?"checked":"" %>>
                        <label for="rb04"><%= (!stqcEnabled) ? "<b>Off</b>" : "Off" %>
                        </label>
                     </font>
                  </td>
                  <td align="center">
   ...
   <form action="cache.jsp">
      <table cellpadding="2" cellspacing="0" border="0">
         <tr>
            ...
            <td><input type="radio" name="stqcLifetime" value="5000"<%= ((stqcLifetime==5000)?" checked":"") %>
                       id="st01"></td>
            <td>
               <font size="-1">
         ...
         <tr>
            <td><input type="radio" name="stqcLifetime" value="10000"<%= ((stqcLifetime==10000)?" checked":"") %>
                       id="st02"></td>
            <td>
               <font size="-1">
...
<ul>
   ...
   <p>
   <form action="cache.jsp"
         onsubmit="return confirm('Changing your caching policy requires an appserver restart.\n\nAre you sure you want to continue?');">
      <table bgcolor="<%= tblBorderColor %>" cellpadding="0" cellspacing="0" border="0" width="300">
         <td>
            <table bgcolor="<%= tblBorderColor %>" cellpadding="3" cellspacing="1" border="0" width="100%">
               <tr bgcolor="#ffffff">
                  <td align="center"<%= (clusteringEnabled) ? " bgcolor=\"#99cc99\"" : "" %>>
                     <font size="-1">
                        ...
                        <label for="rb03"><%= (clusteringEnabled) ? "<b>On</b>" : "On" %>
                        </label>
                     </font>
                  </td>
                  <td align="center"<%= (!clusteringEnabled) ? " bgcolor=\"#cc6666\"" : "" %>>
                     <font size="-1">
                        <input type="radio" name="clusteringEnabled" value="false" id="rb04"
                           <%= (!clusteringEnabled)?"checked":"" %>>
                        <label for="rb04"><%= (!clusteringEnabled) ? "<b>Off</b>" : "Off" %>
                        </label>
                     </font>
                  </td>
                  <td align="center">
...
<ul>
   ...
   <table border=0>
      <tr>
         <td><font size="-1">Used Memory:</font></td>
         <td><font size="-1"><%= mbFormat.format(usedMemory) %> MB</font></td>
      </tr>
      <tr>
         <td><font size="-1">Total Memory:</font></td>
         ...
         <table bgcolor="#000000" cellpadding="1" cellspacing="0" border="0" width="200" align=left>
            <td>
               <table bgcolor="#000000" cellpadding="1" cellspacing="1" border="0" width="100%">
                  ...
                  %>
                  <td bgcolor="#00ff00" width="<%= (100/NUM_BLOCKS) %>%"><img src="images/blank.gif" width="1"
                                                                              height="15" border="0"></td>
                  <% } else { %>
                  <td bgcolor="#006600" width="<%= (100/NUM_BLOCKS) %>%"><img src="images/blank.gif" width="1"
                                                                              height="15" border="0"></td>
                  <% }
                  }
                  %>
