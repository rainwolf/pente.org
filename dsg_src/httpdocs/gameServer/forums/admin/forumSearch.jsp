   ...
   <table bgcolor="#999999" cellpadding="0" cellspacing="0" border="0" width="100%">
      <td>
         <table cellpadding="3" cellspacing="1" border="0" width="100%">
            ...
            <tr bgcolor="#ffffff">
               <td class="forumCell" align="center"><b><%= id %>
               </b></td>
               <td class="forumCell">
               ...
               <td class="forumCell"><i><%= (description != null && !description.equals("")) ? description : "" %>
               </i></td>
               <td align="center" class="forumCell"><%= forum.getThreadCount() %> / <%= forum.getMessageCount() %>
               </td>
               <td align="center">
