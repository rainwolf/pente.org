            ...
            <table cellpadding="4" cellspacing="1" border="0" width="100%">
               ...
               <tr bgcolor="#ffffff">
                  ...
                  <td>
                     ...
                     ><img src="images/arrow_down.gif" width="13" height="9" alt="Move this interceptor down."
                           border="0"></a>
                     <% } else { %>
                     ...
                     ><img src="images/arrow_up.gif" width="13" height="9" alt="Move this interceptor up."
                           border="0"></a>
                     <% } else { %>
                     <img src="images/blank.gif" width="13" height="9" border="0">
                     <% } %>
                  ...
                  <td align="center">
                     ...
                     ><img src="images/button_edit.gif" width="17" height="17"
                           alt="Edit the properties of this interceptor" border="0"
                     ></a>
                  </td>
                  <td align="center">
                     <a href="interceptors.jsp?remove=true&forum=<%= forumID %>&pos=<%= i %>"
                     ><img src="images/button_delete.gif" width="17" height="17" alt="Delete this interceptor"
                           border="0"
                     ></a>
                  </td>
               </tr>
