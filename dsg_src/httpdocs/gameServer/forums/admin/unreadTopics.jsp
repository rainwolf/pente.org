...
%>
   ...
   <font size="-1">
      Category: <b><%= category.getName() %>
   </b>, Forum: <b><%= forum.getName() %>
   </b>
      <p>
         Below is a summary for user <b><%= user.getUsername() %>
      </b>
            <%  if (group != null) { %>
         in group <b><%= group.getName() %>
      </b>.
            <%  } %>
      <p>
            ...
            <tr bgcolor="#ffffff">
               ...
               <td>
                  <font size="-1">
                     ...
                     <i>Guest</i>
                     <% } else { %>
                     <a href="userProfile.jsp?user=<%= author.getID() %>"><%= author.getUsername() %>
                     </a>
                     <% } %>
                  </font>
               </td>
