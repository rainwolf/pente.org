...
<table class="sidebar-group" cellpadding="3" cellspacing="0" border="0" width="100%">
   ...
   <tr>
      <td class="bullet">&#149;</td>
      <td><a href="perms.jsp?mode=<%= FORUM_MODE %>&permGroup=<%= ADMIN_GROUP %>" target="main">Admins/Moderators</a>
      </td>
   </tr>
   <% } %>
   <tr>
   ...
   <tr>
      <td class="bullet">&#149;</td>
      <td><a href="perms.jsp?mode=<%= FORUM_MODE %>&permGroup=<%= CONTENT_GROUP %>" target="main">Global Permissions</a>
      </td>
   </tr>
   <tr>
      <td class="bullet">&#149;</td>
         ...
         <table bgcolor="#a5abc0" cellpadding="1" cellspacing="0" border="0" width="100%">
            <tr>
               <td>
                  <table bgcolor="#d1d9e2" cellpadding="3" cellspacing="0" border="0" width="100%">
                     <tr>
                        <td colspan="3"><b>Group: <%= group.getName() %>
                        </b></td>
                     </tr>
                     <tr bgcolor="#eeeeee">
                        <td>&nbsp;</td>
