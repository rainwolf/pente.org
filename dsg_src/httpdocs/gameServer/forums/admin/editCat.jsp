      ...
      <tr>
         <td>
            <table bgcolor="<%= tblBorderColor %>" cellpadding="3" cellspacing="1" border="0" width="100%">
               ...
               <tr bgcolor="#ffffff">
                  <td align="center" bgcolor="#eeeeee"><font size="-1"><%= category.getID() %>
                  </font></td>
                  <td align="center"><font size="-1"><%= category.getForumCount() %>
                  </font></td>
                  <td align="center"><font size="-1"><%= category.getCategoryCount() %>
                  </font></td>
                  <td align="center"><font size="-1">&nbsp;<%= JiveGlobals.formatDateTime(category.getCreationDate()) %>&nbsp;</font>
                  </td>
                  <td align="center"><font
                     size="-1">&nbsp;<%= JiveGlobals.formatDateTime(category.getModificationDate()) %>&nbsp;</font></td>
               </tr>
            </table>
         </td>
      </tr>
