               ...
               <tr bgcolor="#ffffff">
                  <td align="center"<%= (searchEnabled) ? " bgcolor=\"#99cc99\"" : "" %>>
                     <font size="-1">
                        ...
                        <label for="rb01"><%= (searchEnabled) ? "<b>On</b>" : "On" %>
                        </label>
                     </font>
                  </td>
                  <td align="center"<%= (!searchEnabled) ? " bgcolor=\"#cc6666\"" : "" %>>
                     <font size="-1">
                        <input type="radio" name="searchEnabled" value="false" id="rb02"
                           <%= (!searchEnabled)?"checked":"" %>>
                        <label for="rb02"><%= (!searchEnabled) ? "<b>Off</b>" : "Off" %>
                        </label>
                     </font>
                  </td>
                  <td align="center">
...
<form action="searchSettings.jsp">
   ...
   <ul>
      <table cellpadding="2" cellspacing="0" border="0">
         <tr>
            <td><input type="radio" name="autoIndexEnabled" value="true"
                       id="rb03"<%= (autoIndexEnabled)?"checked":"" %>></td>
            <td><font size="-1"><label for="rb03">Auto-Indexing On</label></font></td>
         </tr>
         <tr>
            <td><input type="radio" name="autoIndexEnabled" value="false"
                       id="rb04"<%= (!autoIndexEnabled)?"checked":"" %>></td>
         ...
         <tr>
            <td>
               ...
               <select size="1" name="indexType">
                  ...
                  <option
                     value="<%= indexers[i][0] %>"<%= (indexType.equals(indexers[i][0])?" selected":"") %>><%= indexers[i][1] %>
                        <%  } %>
               </select>
