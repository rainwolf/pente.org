...
%>
    ...
    <tr bgcolor="#ffffff">
        ...
        <td><font size="-1"><%= LicenseManager.getLicenseID() %></font></td>
    </tr>
    <%  } %>
    <tr bgcolor="#ffffff">
        <td><font size="-1">Product:</font></td>
        <td><font size="-1"><%= LicenseManager.getProduct() %></font></td>
    </tr>
    <tr bgcolor="#ffffff">
        <td><font size="-1">Version:</font></td>
        <td><font size="-1"><%= LicenseManager.getVersion() %></font></td>
    </tr>
    <tr bgcolor="#ffffff">
        <td><font size="-1">License Type:</font></td>
        <td><font size="-1"><%= LicenseManager.getLicenseType() %></font></td>
    </tr>
    <%  if (!isEvaluation) { %>
    <tr bgcolor="#ffffff">
        <td><font size="-1">Copies:</font></td>
        <td><font size="-1"><%= LicenseManager.getNumCopies() %></font></td>
    </tr>
    <%  } %>
    <tr bgcolor="#ffffff">
        <td><font size="-1">License Created:</font></td>
        <td><font size="-1"><%= JiveGlobals.formatDate(LicenseManager.getCreationDate()) %></font></td>
    </tr>
<%  if (!isEvaluation) {
        Date exprDate = LicenseManager.getExpiresDate();
        if (exprDate != null) { %>
