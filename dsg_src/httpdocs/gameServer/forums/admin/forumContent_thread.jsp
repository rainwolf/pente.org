...
%>
    <a href="forumContent_thread.jsp?forum=<%= forumID %>&thread=<%= prevThread.getID() %>"
     title="<%= subj %>"><img src="images/prev.gif" width="10" height="10" hspace="2" alt="Thread: <%= subj %>" border="0"></a>
    <font size="-1">
    <a href="forumContent_thread.jsp?forum=<%= forumID %>&thread=<%= prevThread.getID() %>"
...
%>
    ...
    <a href="forumContent_thread.jsp?forum=<%= forumID %>&thread=<%= nextThread.getID() %>"
     title="<%= subj %>"><img src="images/next.gif" width="10" height="10" hspace="2" alt="Thread: <%= subj %>" border="0"></a>
<%  } else { %>
    &nbsp;
<%  } %>
    </td>
