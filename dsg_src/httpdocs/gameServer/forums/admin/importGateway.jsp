...
%>
   <font size="-1">
      Import all messages into this forum from <% if (gatewayCount > 0) { %>an existing gateway or <% } %> a new
      gateway.
   </font>
<p>
      <% if (gatewayCount > 0) { %>
...
<ul>
   <font size="-1">Import all available messages from an existing gateway.</font>
   <p>
            ...
            <table bgcolor="<%= tblBorderColor %>" cellpadding="3" cellspacing="1" border="0" width="100%">
               ...
               <tr bgcolor="#ffffff">
                  ...
                  <td align="center">
                     ...
                     ><img src="images/button_edit.gif" width="17" height="17" alt="Import using this gateway"
                           border="0"
                     ></a>
                     <% } else if (isNewsgroupGateway) { %>
...
<ul>
   <font size="-1">Import all available messages from a new gateway.</font>
   <p>
   <form action="importGateway.jsp">
      ...
      <table cellpadding="3" cellspacing="0" border="0">
         <tr>
            ...
            <td><font size="-1"><label for="rb04">Email Gateway -- Import all available messages from an email account
               or mailing list.</label></font></td>
         </tr>
         <tr>
            ...
            <td><font size="-1"><label for="rb06">Newsgroup Gateway -- Import all available messages from a NNTP
               newsgroup.</label></font></td>
         </tr>
         <tr>
            <td>&nbsp;</td>
            <td colspan="2"><input type="submit" name="submitButton" value="Import"> <input type="submit"
                                                                                            name="submitButton"
                                                                                            value="Cancel"></td>
         </tr>
      </table>
