   ...
   <tr>
      <td>
         <table bgcolor="<%= tblBorderColor %>" cellpadding="3" cellspacing="1" border="0" width="100%">
            ...
            %>
            <tr bgcolor="#ffffff">
               <td bgcolor="#ebf1f9"><font size="-1"><b><%= forum.getName() %>
               </b></font></td>
               <td align="center"><font size="-1"><%= todayThreadCount %>
               </font></td>
               <td align="center"><font size="-1"><%= todayMessageCount %>
               </font></td>
               <td align="center" bgcolor="#ebf1f9"><font size="-1"><%= yesterdayThreadCount %>
               </td>
               <td align="center" bgcolor="#ebf1f9"><font size="-1"><%= yesterdayMessageCount %>
               </td>
               <td align="center"><font size="-1"><%= weekThreadCount %><br></font><font size="-2"
                                                                                         color="#666666"><%= LocaleUtils.getLocalizedNumber((float) weekThreadCount / nDaysWeek) %>
                  /day</font></td>
               <td align="center"><font size="-1"><%= weekMessageCount %><br></font><font size="-2"
                                                                                          color="#666666"><%= LocaleUtils.getLocalizedNumber((float) weekMessageCount / nDaysWeek) %>
                  /day</font></td>
               <td align="center" bgcolor="#ebf1f9"><font size="-1"><%= monthThreadCount %><br></font><font size="-2"
                                                                                                            color="#666666"><%= LocaleUtils.getLocalizedNumber((float) monthThreadCount / nDaysMonth) %>
                  /day</font></td>
               <td align="center" bgcolor="#ebf1f9"><font size="-1"><%= monthMessageCount %><br></font><font size="-2"
                                                                                                             color="#666666"><%= LocaleUtils.getLocalizedNumber((float) monthMessageCount / nDaysMonth) %>
                  /day</font></td>
            </tr>
            <% } %>
         </table>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
   <tr>
      <% if (start > 0) { %>
      <td width="1%" nowrap><font size="-1"><a href="stats.jsp?start=<%= start-range %>">Stats for previous <%= range %>
         forums</a></font></td>
      <% } else { %>
      ...
      <td width="1%" nowrap><font size="-1"><a href="stats.jsp?start=<%= start+range %>">Stats for next <%= range %>
         forums</a></font></td>
      <% } else { %>
      <td width="1%" nowrap><font size="-1">&nbsp;</font></td>
      <% } %>
