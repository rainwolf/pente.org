...
<p>
   Use the form below to specify where the data in the forum "<b><%= forum.getName() %>
</b>"
   should be moved.
</p>
   ...
   <table cellpadding="3" cellspacing="0" border="0" width="100%">
      ...
      <tr>
         ...
         <td width="99%">
            ...
            <% } %>
            Create forum:
            <input type="text" name="destForumName" size="30" maxlength="100"
            ...
            %>
               <option value="<%= f.getID() %>" class="forum-label"
                       disabled><%= getSep(sep,1) %>&nbsp;&#149;&nbsp;<%= f.getName() %>
