...
<%  if (isGlobal) { %>
    ...
    <ul>
        ...
        <tr>
            <td><input type="radio" name="autoArchiveEnabled" value="true"<%= (autoArchiveEnabled?" checked":"") %> id="rb01"></td>
            <td><font size="-1"><label for="rb01">Auto-Archiving Enabled</label></font></td>
        </tr>
        <tr>
            <td><input type="radio" name="autoArchiveEnabled" value="false"<%= (!autoArchiveEnabled?" checked":"") %> id="rb02"></td>
...
<%  } else { // is not global %>
    ...
    <ul>
        ...
        <table cellpadding="2" cellspacing="0" border="0">
        <tr>
            <td><input type="radio" name="archiveEnabled" value="true"<%= (archiveEnabled?" checked":"") %> id="rb01"></td>
            <td><font size="-1"><label for="rb01">Archiving Enabled</label></font></td>
        </tr>
        <tr>
            <td><input type="radio" name="archiveEnabled" value="false"<%= (!archiveEnabled?" checked":"") %> id="rb02"></td>
