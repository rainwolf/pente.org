   ...
   <tr>
      <td>
         <table bgcolor="#bbbbbb" cellpadding="3" cellspacing="1" border="0" width="100%">
            ...
            <tr bgcolor="#eeeeee">
               <td align="center" nowrap width="1%"><font size="-2" face="verdana"><b>&nbsp; TOPICS &nbsp;</b></font>
               </td>
               <td align="center" nowrap width="1%"><font size="-2" face="verdana"><b>&nbsp; MESSAGES &nbsp;</b></font>
               </td>
               <td align="center" nowrap width="1%"><font size="-2" face="verdana"><b>&nbsp; THIS CATEGORY*
                  &nbsp;</b></font></td>
               <td align="center" nowrap width="1%"><font size="-2" face="verdana"><b>&nbsp; THIS FORUM**
                  &nbsp;</b></font></td>
               <td align="center" nowrap width="1%"><font size="-2" face="verdana"><b>&nbsp; TOPICS &nbsp;</b></font>
               </td>
            </tr>
            ...
            <tr bgcolor="#ffffff">
               ...
               <td>
                  <font size="-1">
                     <a href="editUser.jsp?user=<%= user.getID() %>"><%= user.getUsername() %>
                     </a>
                  </font>
               </td>
               <td>
               ...
               <td align="center" width="1%" nowrap>
                  <font size="-1">
                     ...
                     ><%= readTracker.getUnreadThreadCount(user, forum) %>
                     </a>
                     <% } %>
                  </font>
               </td>
               <td align="center" width="1%" nowrap>
                  <font size="-1">
                     ...
                     <% } else { %>
                     <a href="unreadTopics.jsp?cat=<%= catID %>&forum=<%= forumID %>&user=<%= user.getID() %>&group=<%= groupID %>"
                     ><%= readTracker.getUnreadMessageCount(user, forum) %>
                     </a>
                     <% } %>
                  </font>
               </td>
