         ...
         <td>
            <table cellpadding="4" cellspacing="1" border="0" width="100%">
               ...
               <tr bgcolor="#ffffff">
                  ...
                  <td nowrap><font size="-1"><%= descriptor.getDisplayName() %>
                  </font></td>
                  <td><font size="-1"><%= (description != null) ? description : "&nbsp;" %>
                  </font></td>
                  <% if (filterCount > 1) { %>
                  <td>
                     <% if ((i + 1) < filterCount) { %>
                     <a href="filters.jsp?forum=<%= forumID %>&changePos=true&down=true&filterIndex=<%= i %>"
                     ><img src="images/arrow_down.gif" width="13" height="9" alt="Move this filter down."
                           border="0"></a>
                     <% } else { %>
                  ...
                  <td align="center">
                     ...
                     ><img src="images/button_edit.gif" width="17" height="17" alt="Edit the properties of this filter"
                           border="0"
                     ></a>
                  </td>
                  <td align="center">
                  ...
                  <tr bgcolor="#ffffff">
                     ...
                     <td colspan="<%= (filterCount > 1)?"5":"4" %>">
                        <table cellpadding="2" cellspacing="0" border="0" width="100%">
                           ...
                           <tr bgcolor=<%= (color++ % 2 == 0) ? "#f4f5f7" : "#ffffff" %>>
                              ...
                              <td width="20%" nowrap>
                                 <table cellpadding="2" cellspacing="0" border="0">
                                    <tr>
                                       <td>
                                          <input type="checkbox" name="applyToSubj"
                                                 value="<%= ForumFilterType.FORUM_MESSAGE_SUBJECT %>" id="atsubj"
                                    ...
                                    <tr>
                                       <td>
                                          <input type="checkbox" name="applyToBody"
                                                 value="<%= ForumFilterType.FORUM_MESSAGE_BODY %>" id="atbody"
                                    ...
                                    <tr>
                                       <td>
                                          <input type="checkbox" name="applyToProp"
                                                 value="<%= ForumFilterType.FORUM_MESSAGE_PROPERTY %>" id="atprop"
                           ...
                           <tr bgcolor=<%= (color % 2 == 0) ? "#f4f5f7" : "#ffffff" %>>
                              <td colspan="3">
                                 <font size="-1"><%= descriptors[j].getDisplayName() %>
                                 </font>
                                 <br>
                                 <font size="-2"><%= descriptors[j].getShortDescription() %>
                                 </font>
                              </td>
                           </tr>
                           <tr bgcolor=<%= (color % 2 == 0) ? "#f4f5f7" : "#ffffff" %>>
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <tr valign="top">
                            ...
                            <td width="99%">
                                <input type="checkbox" name="applyToSubj"
                                       value="<%= ForumFilterType.FORUM_MESSAGE_SUBJECT %>" id="ms" checked>
                                <label for="ms">Message Subjects</label>
                                <br>
                                <input type="checkbox" name="applyToBody"
                                       value="<%= ForumFilterType.FORUM_MESSAGE_BODY %>" id="mb" checked>
                                <label for="mb">Message Body</label>
                                <br>
                                <input type="checkbox" name="applyToProp"
                                       value="<%= ForumFilterType.FORUM_MESSAGE_PROPERTY %>" id="mp">
