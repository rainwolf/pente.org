...
<ww:if test="@catWatchCount > 0">
    ...
    <ww:iterator value="watchedCategories" status="'status'">
        ...
        <tr class="<ww:if test="@status/odd==true">jive-odd</ww:if><ww:else>jive-even</ww:else>">
            ...
            <td width="1%" align="center">
                <input type="checkbox" name="email-cat-<ww:property value="@cid" />" value="<ww:property value="@cid" />"
            ...
            <td width="1%" align="center" class="jive-delete">
                <input type="checkbox" name="delete-cat-<ww:property value="@cid" />" value="<ww:property value="@cid" />">
            </td>
        </tr>
...
<ww:if test="@forumWatchCount > 0">
    ...
    <ww:iterator value="watchedForums" status="'status'">
        ...
        <tr class="<ww:if test="@status/odd==true">jive-odd</ww:if><ww:else>jive-even</ww:else>">
            ...
            <td width="1%" align="center">
                <input type="checkbox" name="email-forum-<ww:property value="@fid" />" value="<ww:property value="@fid" />"
                 <ww:if test="hasEmailWatch(.) == true">checked</ww:if>>
            </td>
            <td width="1%" align="center">
                <input type="checkbox" name="save-forum-<ww:property value="@fid" />" value="<ww:property value="@fid" />"
                 <ww:if test="isExpirableWatch(.) == false">checked</ww:if>>
            </td>
            <td width="1%" align="center" class="jive-delete">
                <input type="checkbox" name="delete-forum-<ww:property value="@fid" />" value="<ww:property value="@fid" />">
            </td>
        </tr>
...
<ww:if test="@threadWatchCount > 0">
    ...
    <ww:iterator value="watchedThreads" status="'status'">
        ...
        <tr class="<ww:if test="@status/odd==true">jive-odd</ww:if><ww:else>jive-even</ww:else>">
            ...
            <td width="1%" align="center">
                <input type="checkbox" name="email-thread-<ww:property value="@tid" />" value="<ww:property value="@tfid" />-<ww:property value="@tid" />"
                 <ww:if test="hasEmailWatch(.) == true">checked</ww:if>>
            </td>
            <td width="1%" align="center">
                <input type="checkbox" name="save-thread-<ww:property value="@tid" />" value="<ww:property value="@tfid" />-<ww:property value="@tid" />"
                 <ww:if test="isExpirableWatch(.) == false">checked</ww:if>>
            </td>
            <td width="1%" align="center" class="jive-delete">
                <input type="checkbox" name="delete-thread-<ww:property value="@tid" />" value="<ww:property value="@tfid" />-<ww:property value="@tid" />">
            </td>
        </tr>
