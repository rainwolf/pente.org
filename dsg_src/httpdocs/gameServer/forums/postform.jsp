    ...
    <td width="98%">
        ...
        <ww:else>
            ...
            <jive:i18n key="post.post_in_forum">
                <jive:arg>
                    <a href="forum.jspa?forumID=<ww:property value="$forumID" />&start=0"><ww:property value="forum/name" /></a>
                </jive:arg>
            </jive:i18n>
...
<tr>
    ...
    <td>
        ...
        <tr>
            ...
            <ww:if test="reply == true">
                <td><input type="submit" name="doQuoteOriq" accesskey="q" class="fontButton" value="<jive:i18n key="post.quote" />" tabindex="<ww:property value="@tabIndex/next" />"></td>
            </ww:if>
        </tr>
        </table>
    </td>
...
<!--
    ...
    <script type="text/javascript">
        ...
        <%
          ReCaptcha c = ReCaptchaFactory.newReCaptcha("6LdZFuYSAAAAAKGplPdNwVtlb3CSqL9JrVQgRSCb", "6LdZFuYSAAAAAML0nbMAHbkzC7U6uy19FHkQUv1p", false);
...
--> 
    ...
    <!-- <form action="?" method="POST"> -->
      <div class="g-recaptcha" data-sitekey="6LdZFuYSAAAAAKGplPdNwVtlb3CSqL9JrVQgRSCb"></div>
      <br/>
      <!-- <input type="submit" value="Submit"> -->
    <!-- </form> -->
...
<tr>
    ...
    <td>
        ...
        <input type="submit" name="doPreview" value="<jive:i18n key="global.preview" />" tabindex="<ww:property value="@tabIndex/next" />">

        <ww:if test="canAttach(forum) == true">
            <%-- attach files --%>
            <input type="submit" name="doAttach" value="<jive:i18n key="post.attach_files" />" tabindex="<ww:property value="@tabIndex/next" />">
        </ww:if>
