...
<jsp:include page="header.jsp" flush="true">
   <jsp:param name="pageWidth" value="800"/>
</jsp:include>
...
<tr>
    ...
    <td width="1%"><input type="text" name="q" size="40" maxlength="100"
                          value="<ww:if test="q"><ww:property value="q" /></ww:if>"></td>
    <%-- Search (button) --%>
            ...
            <jive:cache id="paginator">
               ...
               <ww:if test="numPages > 1">
                    ...
                    <ww:if test="nextPage == true">
                       ...
                       <%-- Next --%>
                       | <a
                       href="search!execute.jspa?<ww:property value="searchParams" />&start=<ww:property value="nextPageStart" />"
