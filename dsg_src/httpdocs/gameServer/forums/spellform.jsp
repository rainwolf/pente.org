...
<ww:if test="$g-recaptcha-response">
   <%
      ...
      URL url = new URL("https://www.google.com/recaptcha/api/siteverify?secret=6LdZFuYSAAAAAML0nbMAHbkzC7U6uy19FHkQUv1p&response=" + gReCaptchaResponse);
                ...
                <ww:if test="hasSuggestions == true">
                    ...
                    <tr valign="top">
                        ...
                        <ww:if test="misspelledWords == true">
                           ...
                           <td>
                                <input type="text" name="newWord" size="20" maxlength="50"
                                       value="<ww:property value="suggestions[0]" />">
                            </td>
                           <td rowspan="2">
                                ...
                                <tr>
                                    <%-- Change --%>
                                    <td><input type="submit" name="doChange" value="<jive:i18n key="spell.change" />"
                                               class="jive-spell-button"></td>
                                    <%-- Ignore --%>
                                    <td><input type="submit" name="doIgnore" value="<jive:i18n key="spell.ignore" />"
                                               class="jive-spell-button"></td>
                                </tr>
                                <tr>
                                    <%-- Change all --%>
                                    <td><input type="submit" name="doChangeAll"
                                               value="<jive:i18n key="spell.change_all" />"
                                               class="jive-spell-button"></td>
                                    <%-- Ignore all --%>
                                    <td><input type="submit" name="doIgnoreAll"
                                               value="<jive:i18n key="spell.ignore_all" />"
                                               class="jive-spell-button"></td>
                                </tr>
                                </table>
                         ...
                         <ww:else>
                            ...
                            <td><input type="submit" name="doDeleteSecond"
                                       value="<jive:i18n key="spell.remove_duplicated_word" />"
                                       class="jive-spell-button"></td>
                            <%-- Ignore --%>
                            <td><input type="submit" name="doIgnore" value="<jive:i18n key="spell.ignore" />"
                                       class="jive-spell-button"></td>
