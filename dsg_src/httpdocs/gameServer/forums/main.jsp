...
<%  if (category.getID() != 1L) { %>
    ...
    <tr>
        <td>
            ...
            <tr>
                <td><a href="index.jspa?categoryID=<%= category.getParentCategory().getID() %>"><img src="images/up-16x16.gif" width="16" height="16" border="0"></a></td>
                <td>
        ...
        <td>
            <table cellpadding="3" cellspacing="0" border="0">
            <tr>
                <td><a href="index.jspa?categoryID=<%= category.getParentCategory().getID() %>"><img src="images/back-to-16x16.gif" width="16" height="16" border="0"></a></td>
                <td>
                    <span class="jive-button-label">
        ...
        %>
            ...
            <tr>
                <td class="jive-category-name" colspan="4">
                    <a href="index.jspa?categoryID=<%= subCategory.getID() %>"><%= subCategory.getName() %></a>
                        ...
                        <ww:property value="forumFactory/rootForumCategory" escape="false">
                            <ww:if test="forumCount <= 20">
                                    ...
                                    <ww:iterator value="forums">
                                        <option value="f<ww:property value="ID" />">&nbsp;&#149;&nbsp; <ww:property value="name" />
                                    </ww:iterator>
                            </ww:if>
                        </ww:property>
                        </select>
