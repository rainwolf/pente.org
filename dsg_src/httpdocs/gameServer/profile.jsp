...
<table border="0" cellpadding="2" cellspacing="0" width="100%">
 ...
 -->         <%= dsgPlayerData.getName() %>
            ...
            <tr>
               ...
               <td>
                  <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
                     ...
                     <font color="<%= textColor2 %>"><b><% if (hoursDiff2 >= 0) { %>+<% } %><%= hoursDiff2 %>
                     </b> hours from you</font>
                  </font>
               </td>
            </tr>
            <tr>
     ...
     width:90%;">
                     <% if (dsgPlayerData.hasPlayerDonated()) { %>
                     <%=dsgPlayerData.getName()%> has
                     unlimited <%=(dsgPlayerData.unlimitedMobileTBGames() && (!dsgPlayerData.unlimitedTBGames())) ? "(mobile-only) " : ""%>
                     turn-based
                     games<%=dsgPlayerData.databaseAccess() ? ", database access" : ""%><%=dsgPlayerData.showAds() ? " but will see advertisements" : ", and will not see advertisements"%>
                     .<br>
