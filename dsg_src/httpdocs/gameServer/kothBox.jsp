   ...
   DSGPlayerData d = dsgPlayerStorer.loadPlayer(players.get(i).getPlayer().getPid());
    String color = i % 2 == 1 ? "style=\"background:white\"" : ""; 
        ...
        %> 
           <tr <%= color %>>
            <!-- <td>&nbsp;&nbsp;</td> -->
            <td><a href="/gameServer/stairs.jsp?game=<%=players.get(i).getGame()%>"><b><%=(players.get(i).getGame()>50?"TB-":"") + GridStateFactory.getGameName(players.get(i).getGame())%></b></a></td>
            <td align="right"><%@ include file="playerLink.jspf" %>&nbsp;</td>
           </tr>
<% } %>
    </table>
