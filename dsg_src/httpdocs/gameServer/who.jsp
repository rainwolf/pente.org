...
<%@ include file="begin.jsp" %>
    ...
    <div style="font-family:Verdana, Arial, Helvetica, sans-serif;
		...
		margin-bottom:10px;
	        font-weight:bold;
	        width:90%;">
	Note: You can now see who's online from your <a href="/gameServer/index.jsp">Dashboard</a> page, this page will probably go away at some point.
  </div>
       ...
       <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
          ...
          <%  }
                ...
                for (int i = 0; i < d.length; i++) {
                   ...
                   <% } %>
                      ...
                      <tr bgcolor="<%= bgColor1 %>"><td colspan="3">
                        <font color="white">
                ...
                <%  } %>
                  <tr>
                    ...
                    <td><a href="<%= request.getContextPath() %>/gameServer/profile?viewName=<%= d[i].getPlayerName() %>">
                        <%= d[i].getPlayerName() %></a>
                        <%@ include file="tournaments/crown.jspf" %>&nbsp;&nbsp;&nbsp;</td>
                    <% } else { //guest %>
                       <td><%= d[i].getPlayerName() %></td>
                    <% } %>
                     <td>
          ...
          <br>
		     ...
		     <table border="1" cellpadding="1" cellspacing="0" 
               ...
               <tr bgcolor="<%= bgColor1 %>"><td colspan="<%= columns %>">
                 <font color="white">
