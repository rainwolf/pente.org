                     ...
                     <tr>
                        <td>
                           <div style="height:250px;position: relative; overflow:hidden;">
                              <div id="movesTable"
                                   style="height:250px; width: 270px; right: -20px; position: absolute; align: right; overflow:auto;">
                  ...
                  <table align="right" border=1 width="250px">
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <img
                              src="/gameServer/images/<%= SimpleDSGPlayerGameData.getRatingsGifRatingOnly(playerData.getRating()) %>">
                        </td>
                     </tr>
                     <tr>
                        <td>Player 2
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a href="javascript:goWH('/gameServer/viewLiveGame?g=<%= otherGame %>&mobile');">other game
                              in the set</a>
...
<tr>
   <td>
      ...
      <a class="button" href="/gameServer/pgn.jsp?g=<%= game.getGameID() %>"><span
         style="color:white">Text version</span></a>
      <% if (!game.isPrivateGame()) { %><a class="button" style="clear:right;"
                                           href="/gameServer/forums/post!default.jspa?forumID=27&body=<%= URLEncoder.encode("[game]"+game.getGameID()+"[/game]\n\nEnter your comments here") %>&subject=<%= URLEncoder.encode("Game: " + game.getPlayer1Data().getUserIDName() + " vs. " + game.getPlayer2Data().getUserIDName() + " " + dateFormat.format(game.getDate().getTime())) %>"><span
      style="color:white">Discuss this game</span></a><% } %>
