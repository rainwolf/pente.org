...
<div style="font-family:Verdana, Arial, Helvetica, sans-serif;
 float:left;width:70%">
   ...
   <h2 style="margin:0;padding:0;">Dashboard -
      Hi <%= (dsgPlayerData.hasPlayerDonated() ? "<span style='color:#" + Integer.toHexString(dsgPlayerData.getNameColorRGB()).substring(2) + "'>" : "<span>") %>
         <%= dsgPlayerData.getName() %></span>!</h2>
   ...
   <div style="font-family:Verdana, Arial, Helvetica, sans-serif;
	 ...
	 width:100%;">
      ...
      <ul>
         ...
         --%>
         <li>Trouble finding a game? Try posting an <a href="http://www.pente.org/gameServer/tb/new.jsp">open
            invitation</a><%= openTBgames > 0 ? " or try " + (openTBgames == 1 ? "" : "one of ") + "the <a href=\"http://www.pente.org/gameServer/tb/waiting.jsp\">" + openTBgames + " open turn-based invitation" + (openTBgames == 1 ? "" : "s") + "</a>" : ""%>
            .
         </li>
         </li>
         <%--
   ...
   <div class="buttonwrapper">
      ...
      <div style="margin-top:5px;">
         ...
         <select name="lobbies">
            ...
            <option value="<%= data.getPort() %>"><%= data.getName() %>
            </option>
            <% } %>
            <% } %>
         </select>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
   <tr>
      <td align="left" colspan="2">
         <div class="buttonwrapper">
            <a class="boldbuttons" href="/gameServer/tb/new.jsp"><span>Start a Game</span></a> <a class="boldbuttons"
                                                                                                  href="/gameServer/tb/waiting.jsp"
                                                                                                  style="margin-right:6px; margin-left: 6px"><span>Find an Open Game <b>(<%=openTBgames %>)</b></span></a>

            <div style="margin-top:7px;">
               Active games: <b><%= numberFormat.format(siteStatsData.getNumTbGames()) %>
            </b>, Open TB games: <b><%=openTBgames %>
            </b><%-- --%>
            </div>
         </div>
      </td>
