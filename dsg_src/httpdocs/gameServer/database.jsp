   ...
   <tr>
      <td valign="top" colspan="2">
         ...
         <table width="390" border="1" cellspacing="0" cellpadding="1" bordercolor="black" bgcolor="<%= bgColor1 %>">
            ...
            <tr>
               <td><b><font color="white"><%= numberFormat.format((long) gameStats.getNumGames()) %>
               </b></font></td>
               <td><b><font color="white"><%= numberFormat.format((long) gameStats.getNumMoves()) %>
               </b></font></td>
               <td><b><font color="white"><%= numberFormat.format((long) gameStats.getNumPlayers()) %>
               </b></font></td>
               <td><b><font color="white"><%= numberFormat.format((long) gameStats.getNumSites()) %>
               </b></font></td>
            </tr>
   ...
   <tr>
      <td width="800" align="left" valign="top">
         <table cellspacing="0" cellpadding="0" border="0">
            ...
            <tr>
               <td></td>
               <td colspan="21" width="<%=totalWidth%>"><img
                  src="<%= request.getContextPath() %>/gameServer/images/black_pixel.gif" width="<%=totalWidth%>"
                  height="5"></td>
               <td></td>
            </tr>
            ...
            <tr>
               ...
               <td width="5"><img src="<%= request.getContextPath() %>/gameServer/images/black_pixel.gif" width="5"
                                  height="<%=tileWidth%>"></td>
               ...
               <td><a href="javascript:addMove('<%= moveStr %>')"
                  <%              if (boardImages[i][j].endsWith("light_green.gif")) { %>
                      onmouseover="javascript:highlightStat('<%= moveStr %>s');"
                      onmouseout="javascript:unHighlightStat('<%= moveStr %>s');"
                  <%              } %>
               ><img name="<%= moveStr %>" src="<%= boardImages[i][j] %>" width="<%=tileWidth%>" height="<%=tileWidth%>"
                     border="0"></td>
               <% } %>
            ...
            <tr>
               ...
               <td></td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc0" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc1" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc2" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc3" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc4" width="19"
                         height="19">
               </td>
               <td></td>
               <td></td>
               ...
               <td></td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc0" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc1" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc2" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc3" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc4" width="19"
                         height="19">
               </td>
               <td></td>
               <td>&nbsp;</td>
            ...
            <tr>
               ...
               <td></td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc5" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc6" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc7" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc8" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc9" width="19"
                         height="19">
               </td>
               <td></td>
               <td></td>
               ...
               <td></td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc5" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc6" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc7" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc8" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc9" width="19"
                         height="19">
               </td>
               <td></td>
               <td>&nbsp;</td>
            ...
            <tr>
               ...
               <td></td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc10" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc11" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc12" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc13" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc14" width="19"
                         height="19">
               </td>
               <td></td>
               <td></td>
               ...
               <td></td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc10" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc11" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc12" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc13" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc14" width="19"
                         height="19">
               </td>
               <td></td>
               <td>&nbsp;</td>
            ...
            <tr>
               ...
               <td></td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc15" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc16" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc17" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc18" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="wc19" width="19"
                         height="19">
               </td>
               <td></td>
               <td></td>
               ...
               <td></td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc15" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc16" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc17" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc18" width="19"
                         height="19">
               </td>
               <td>
                  <image src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif" name="bc19" width="19"
                         height="19">
               </td>
               <td></td>
               <td>&nbsp;</td>
         ...
         <center>
            <form name="data_form">
               ...
               <input type="hidden" name="results_order"
                      value="<%= data.getGameStorerSearchRequestData().getGameStorerSearchResponseOrder() %>">
               <input type="hidden" name="zippedPartNumParam"
                      value="<%= ((SimpleHtmlGameStorerSearchRequestData) data.getGameStorerSearchRequestData()).getStartZippedPartNum() %>">
               <table width="100%" border="0">
                  <tr>
                     <td width="45%" align="center">
                        <input type="button"
                               style="background-color:#257626;color: white;font-size: 24px;padding: 5px 20px;"
                               onclick="javascript:firstMove()" value=" << ">
                        <input type="button"
                               style="background-color:#257626;color: white;font-size: 24px;padding: 5px 20px;"
                               onclick="javascript:backMove()" value="  <  ">
                        <input type="button"
                               style="background-color:#257626;color: white;font-size: 24px;padding: 5px 20px;"
                               onclick="javascript:forwardMove()" value="  >  ">
                        <input type="button"
                               style="background-color:#257626;color: white;font-size: 24px;padding: 5px 20px;"
                               onclick="javascript:lastMove()" value=" >> ">
                     </td>
                     <td width="55%" align="center">
                        <input type="button"
                               style="background-color:#257626;color: white;font-size: 24px;padding: 5px 20px;"
                               onclick="javascript:resetGame()" value="Reset">
                        <input type="button"
                               style="background-color:#257626;color: white;font-size: 24px;padding: 5px 20px;"
                               onclick="javascript:clearGame('K10')" value="Clear">
                        <input type="button"
                               style="background-color:#257626;color: white;font-size: 24px;padding: 5px 20px;"
                               onclick="javascript:search()" value="Search">
                     </td>
                  </tr>
               </table>
            </form>
...
%>
               ...
               <tr bgcolor="<%= bgColor2 %>">
                  ...
                  <td><img name="<%= move %>s" src="<%= request.getContextPath() %>/gameServer/images/stats_blank.gif">
                     <a style="font-weight:normal;" href="javascript:addMove('<%= move %>');"
                        ...
                        onmouseout="javascript:unHighlightMove('<%= move %>');"><%= move %>
                     </a></td>
                  <% } %>

                  <td><%= numberFormat.format((long) moveData.getGames()) %>
                  </td>
                  <td><%= percentFormat.format(moveData.getPercentage()) %>
                  </td>
               </tr>
   ...
   <tr>
      <td colspan="2">
         <form name="loadGameForm" action="<%= request.getContextPath() %>/gameServer/controller/load_game"
               method="POST">
            ...
            <form name="filter_data">
               ...
               <table border="1" cellpadding="1" cellspacing="0" bordercolor="black" width="100%">
                  ...
                  <tr bgcolor="<%= bgColor2 %>">
                     ...
                     <td><a href="<%= p1Link %>"><font
                        color="<%= gameData.getWinner() == GameData.PLAYER1 ? "#8b0000" : "black" %>"><%= gameData.getPlayer1Data().getUserIDName() %>
                     </font></a></td>
                     <td><a href="<%= p2Link %>"><font
                        color="<%= gameData.getWinner() == GameData.PLAYER2 ? "#8b0000" : "black" %>"><%= gameData.getPlayer2Data().getUserIDName() %>
                     </font></a></td>
                     <td><a href="<%= gameData.getSiteURL() %>"><%= gameData.getShortSite() %>
                     </a></td>
                     <td><a
                        href="/gameServer/viewLiveGame?mobile&g=<%= gameData.getGameID() %>"><%= gameData.getEvent() %>
                     </a></font></td>
                     <td><%= gameData.getRound() == null ? "&nbsp;-" : gameData.getRound() %>
                     </td>
                     <td><%= gameData.getSection() == null ? "&nbsp;-" : gameData.getSection() %>
                     </td>
                     <td><%= dateFormat.format(gameData.getDate()) %>
                     </td>
                  </tr>
                  <% } %>
                  ...
                  <tr bgcolor="<%= bgColor2 %>">
                     <td colspan="9">
                        <table border="0" cellpadding="0" cellspacing="0" bordercolor="black" width="100%">
                           ...
                           <tr>
                              ...
                              <td width="7%"><a href="javascript:downloadGames('<%= i %>');"><%= i %>
                              </a></td>
                              <% } %>
                              <td width="7%">
