               ...
               <tr>
                  <td align="center">
                     ...
                     <font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="black">
                        ...
                        <b><font color="<%= textColor2 %>" size="3"><%= tournamentPlayers.size() %>
                        </font></b> Players currently signed up!
                        <div
                           style="width: 350px; height: 100px; overflow: auto;  margin: 0 1px 0 1px; border: 1px solid black">
                           ...
                           <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              ...
                              <tr>
                                 <td align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="black"
                                                          size="2">
                                       <%= (i + 1) %>
                                 </td>
                                 ...
                                 <td align="center"><font color="black" face="Verdana, Arial, Helvetica, sans-serif"
                                                          size="2">
                                    <%= t.getTotalGames() %>
                                 </font></td>
                              </tr>
