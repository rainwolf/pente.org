...
<a href="https://www.pente.org/gameServer/viewLiveGame?mobile&g=<%= gameData.getGameID() %>"><%= gameData.getEvent() %></a><br><%= dateFormat.format(gameData.getDate()) %></td><td align="right">
<%
...
<a href="<%= p1Link %>"><font color="<%= gameData.getWinner() == GameData.PLAYER1 ? "#8b0000" : "black" %>"><%= gameData.getPlayer1Data().getUserIDName() %></font></a> vs <a href="<%= p2Link %>"><font color="<%= gameData.getWinner() == GameData.PLAYER2 ? "#8b0000" : "black" %>"><%= gameData.getPlayer2Data().getUserIDName() %></font></a>,
