...
<h2>Swiss</h2>
 ...
 <ol>
   ...
   <li>After round 1, players are then sorted by wins, (and possibly
       secondly opponent wins or some other factor yet to be determined).</li>
   <li>So in round 2, if there are two players who are 4-0, they will
       ...
       playing another player who is closest to your skill level.</li>
   <li>If however, 2 players are
       ...
       that is still close to the system of pairing by wins.</li>
   <li>Play continues for a pre-determined number of rounds, based on
       ...
       single elimination playoff to determine the winner.</li>
   <li>Vacation time is allowed. If requested in advance of the start of
       ...
       will receive a 2-2 for the round.</li>
 </ol>
