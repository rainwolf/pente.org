    ...
    <tr>
      <td colspan="2">
        <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
          ...
          <b><a href="javascript:submitToDatabase('Pente.org', 'Tournament 4A', 'All Rounds', 'All Sections');">View Section A Games</a></b><br>
          <b><a href="javascript:submitToDatabase('Pente.org', 'Tournament 4B', 'All Rounds', 'All Sections');">View Section B Games</a></b><br>
       ...
       <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
         ...
         <%  int currentRound = 0, currentSection = 0;
             for (int i = 0; i < tournament4AData.size(); i++) {
                 ...
                 if (d.section != currentSection) {
                     ...
                     &nbsp;&nbsp;<b><a href="#tournament4A-<%= currentRound %>.<%= currentSection %>">Round <%= currentRound %> - Section <%= currentSection %></a></b><br>
              <% }
             } %>
         <br>
         ...
         <%  currentRound = 0;
             for (int i = 0; i < tournament4BData.size(); i++) {
                 ...
                 if (d.round != currentRound) {
                     currentRound = d.round; %>
                     &nbsp;&nbsp;<b><a href="#tournament4B-<%= currentRound %>">Round <%= currentRound %></a></b><br>
              <% }
             } %>
      ...
      <td width="100%">
       ...
       <% currentRound = 0;
                 ...
                 <tr bgcolor="<%= bgColor1 %>">
                   <td colspan="4">
                    <font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="white">
                     <a name="tournament4A-<%= currentRound %>.<%= currentSection %>"><b>Round <%= currentRound %> - Bracket <%= currentSection %></b>
                    </font>
                   </td>
                 </tr>
              <% if (edit ) { %>
          ...
          <tr>
            <td width="25%">
              <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
                <a href="../../profile?viewName=<%= d.getPlayer1() %>"><%= d.getPlayer1() %></a> <% if (d.getSeed1() != 0) { %> (<%= d.getSeed1() %>) <% } %>
              </font>
            </td>
            <td width="25%">
              <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
                ...
                <%     for (resultsIterator = 0; resultsIterator < gameResults.length; resultsIterator++) { %>
                           <option value="<%= gameResults[resultsIterator] %>" <% if (gameResults[resultsIterator].equals(d.getResult())) { %> selected <% } %>><%= gameResults[resultsIterator] %>
                <%     } %>
                       </select>
                <% } else { %>
                       <%= d.getResult() %>
            ...
            <td width="25%">
              <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
                <a href="../../profile?viewName=<%= d.getPlayer2() %>"><%= d.getPlayer2() %></a> <% if (d.getSeed2() != 0) { %> (<%= d.getSeed2() %>) <% } %>
              </font>
            </td>
            <td width="25%">
              <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
          ...
          for (int i = 0; i < tournament4BData.size(); i++) {
             ...
             if (d.round != currentRound) {
                 ...
                 <tr bgcolor="<%= bgColor1 %>">
                   <td colspan="4">
                    <font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="white">
                     <a name="tournament4B-<%= currentRound %>"><b>Round <%= currentRound %></b>
                    </font>
                   </td>
                 </tr>
          <% } %>
