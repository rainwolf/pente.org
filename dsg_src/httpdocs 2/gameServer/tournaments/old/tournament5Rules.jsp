<% pageContext.setAttribute("title", "Tournament 5 Rules/Format"); %>
<%@ include file="../../begin.jsp" %>

<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
    <h3>Tournament 5 Rules/Format</h3>
    </td>
  </tr>
  <tr> 
    <td>
      <font face="Verdana, Arial, Helvetica, sans-serif" size="2">
         ...
         <center>Winter 2004 real-time Pente Championship (Pente.org Tournament #5)<br>
         Two sections beginning January, 2004<br>
         </center>
         <br>
         ...
         <br>
         <b>General</b><br>
         <b>&nbsp;&nbsp;&nbsp;<a href="#general-format">Format and pairings</a></b><br>
         <b>&nbsp;&nbsp;&nbsp;<a href="#general-pairings">Pairings for regular rounds</a></b><br>
         <b>&nbsp;&nbsp;&nbsp;<a href="#general-matches">Matches and time controls for regular rounds</a></b><br>
         <b>&nbsp;&nbsp;&nbsp;<a href="#general-pairings2">Pairings for playoffs</a></b><br>
         <b>&nbsp;&nbsp;&nbsp;<a href="#general-matches2">Matches and time controls for playoffs</a></b><br>
         <br>
         ...
         <br><br>
         <b><a name="sectionA">Section A (Swiss System)</b><br>
...
opponents at Pente.org AND have never had an established rating of 1750 or higher.</li>
</ol>

<b><a name="general-format">Format and pairings:</b>
<ol>
  <li>Swiss system format.  All players play matches in all rounds.  The # of
      ...
      7 rounds.</li>
  <li>After the rounds have been played, the top 4 (if 4-5 rounds) or 8 (if 6-7
...
<b><a name="general-pairings">Pairings for regular rounds:</b>
<ol>
  <li>The pairings in round 1 are random.  Wins by all players in their matches
      are noted.</li>
  <li>After round 1, in each round, players are placed (sorted) by total wins
      ...
      randomly amongst themselves.</li>
  <li>Pairings after round 1 are from the places established in number 2 and
      ...
      re-placing in each subsequent round.</li>
  <li>Vacation time is allowed.  If requested in advance of the start of the
      ...
      wins, 2 losses.</li>
  <li>If there are an odd # of players available for play in the round, then the
...
<b><a name="general-matches">Matches and time controls for regular rounds:</b>
<ol>
  <li>A match consists of 4 games, each player moving first in 2 games.  No
      ...
      total.</li>
  <li>All 4 games should be completed in one sitting in order to avoid
...
<b><a name="general-pairings2">Pairings for playoffs:</b>
<ol>
  <li>After the regular rounds are complete, the top 4 (if 4-5 rounds) or top 8
      ...
      <ol>
        <li>1st tiebreaker - Total tournament wins by all opponents, as done for
            pairings in the regular rounds.</li>
        <li>2nd tiebreaker - Total forfeit points, as follows:
            <ol>
              <li>If any opponent of the tied player forfeited a match to a
                  ...
                  each opponent that forfeited to someone else.</li>
              <li>If any opponent forfeited a match to the tied player, the tied
                  ...
                  that forfeited to him before the last round.</li>
            </ol></li>
  ...
  <li>The pairings for the playoff rounds will be the highest remaining seed vs.
      the lowest remaining seed, the 2nd highest vs. 2nd lowest, etc.</li>
</ol>

<b><a name="general-matches2">Matches and time controls for playoffs:</b>
<ol>
  <li>A match consists of one or more 2-game sets.  Sets consist of 2 games,
      ...
      Playoffs continue until 1 player remains.</li>
  <li>For match coordination issues, see nos. 1-3 under General match and
      pairings issues.</li>
  <li>The time limit for each game will be the same as the regular rounds,.</li>
  <li>If 6 games (3 sets) have been played and the match is still tied, if BOTH
      ...
      <b>IMPORTANT</b>:  For reduced time controls, you will need to change the
         site default time of 20 minutes.</li>
  <li>The time period to complete matches for the playoff rounds will be the
      ...
      <ol>
        <li>The last game of the match was completed in the last 3 days of the
            time period.</li>
        <li>The players cannot agree on a time to complete their match.</li>
        <li>Both players have made every effort to break the tie.  The section
            ...
            effort has been made.</li>
      </ol></li>
</ol>

<b><a name="general-match">Match and Pairings Issues</b>
<ol>
  <li>Players must arrange with their opponents a time to meet and play their
      ...
      able to make that time will forfeit.</li>
  <li>For playoff elimination matches that must be won by 2 games, if 2 sets (4 games) have
      ...
      <ol>
        <li>If it is the last 2 days of the time period for the round, player A
            ...
            continue the match, but can do so if he wishes.</li>
        <li>If it is before the last 2 days of the time period for the round,
            ...
            one of them or forfeit the match.</li>
        <li>In order to claim that player A should forfeit the match, player B
            ...
            reasonable playing times.</li>
      </ol></li>
  <li>For playoff elimination matches that must be won by 2 games, if at least 3 sets
      ...
      <ol>
        <li>If only one player (player A) wishes to adjourn AND it is the last 2
            days of the time period for the round, he could potentially forfeit
            the match.  Rules 2.1 and 2.3 above will apply.</li>
        <li>If BOTH players wish to adjourn AND it is the last 2 days of the
        ...
        <li>If it is before the last 2 days of the time period for the round,
            ...
            see number 1 under General match and pairings issues.</li>
      </ol></li>
</ol>
...
<ol>
  <li>The directors will place players into the appropriate sections as
      ...
      in section A.</li>
  <li>If a player wishes to play in section B and his rating qualifies him to
      do so, he must have completed at least 20 rated games vs. at least 3
      different opponents at Pente.org.
  </li>
  <li>The tournament directors and co-directors will be playing in the
      ...
      director.</li>
  <li>Rounds will start every 2 weeks.  The time period to play matches in each
      ...
      period will be extended by one week.</li>
  <li>A break for the players between games of a match of 5-10 minutes is
      ...
      if they are not ready.</li>
  <li>All games should be played as rated games and the time controls should be
      ...
      not required:
    <ol>
      <li>If 7 or less moves have been played and if both players agree, the
          ...
          position when the error was discovered.</li>
      <li>If more than 7 moves have been played, the game should continue in
          order to prevent matches from taking too long.</li>
    </ol></li>
  <li>If Pente.org site is down or not available for play at any time, the time period
    ...
    <ol>
      ...
      <li>If the site is unavailable for at least 6 but less than 30 hours AND
          ...
          if possible.</li>
      <li>If the site is unavailable for 30 or more hours, then the time period
          for the round will be extended by one week.</li>
    </ol></li>
  <li>If a player is bumped off of Pente.org while playing, the site will
      ...
      prevent abuse of this allowance.</li>
  <li>No player may enter the tournament under two or more user ID's.</li>
  <li>If a player has more than one user IDs (a normal name and a speed name for example) the player should play with the non-speed name that has the most games played.</li>
  <li>No assistance from any other person, computer software, notes, books, game
      transcripts, or databases is permitted.</li>
  <li>Players are not allowed to move pieces (stones) around on any physical or
      ...
      determine possible outcomes of moves.</li>
  <li>The use of the UNDO request is permitted, but an opponent is NOT obligated
      ...
      player to take back the move, but is not obligated to do so.</li>
  <li>At the completion of a MATCH, the winner of the match should E-mail the
      ...
      automatically send the moves of a game to his E-mail address.</li>
  <li>All disputes must be brought to the attention of the section director
      immediately.</li>
  <li>Any player showing poor conduct or sportsmanship can be removed from the
      tournament at the discretion of the director(s) and/or co-director.</li>
  <li>Anyone is allowed to watch games in progress.  Comments should be avoided
      at the table where a tournament game is being played.  The following will
      apply:
    <ol>
      <li>If a person who is watching a game isn’t sure if it is a tournament
          game, he can ask the players.</li>
      <li>If a person who is watching makes general conversion, the players
          should politely state ‘quite please, tournament game’.  If the person
          isn’t aware of the rule, refer him to the tournament rules.</li>
      <li>In between games of a match, anyone can make general conversion or
          sporting comments about the game.  However once the next game starts,
          talking should cease once again.</li>
      <li>See number 16 if someone refuses to refrain from comments during the
...
<ol>
  <li>Allow at least 3 hours of time for matches.  It is not possible to know
      ...
      minutes (section B) each if both players use most of their time.</li>
  <li>Before a match begins, players should inform family members and friends
      ...
      games.  (See number 5 under General rules.)</li>
  <li>It is recommended that players play at a table that is completely empty of
      ...
      table.</li>
  <li>If possible, players should not wait until the last 2 days of the 10-11
      day time period to play their matches for the following reasons:
    <ol>
      <li>Something could come up that prevents one of the players from playing
          in a match, resulting in a forfeit.</li>
      <li>The site could experience problems making it difficult to play or
          complete a match.  (See number 7 under General rules.)</li>
      <li>If the games go longer than expected, one of the players could end up
          ...
          both players.  (See specifics under general match and pairings issues.)</li>
    </ol></li>
  <li>When coordinating a playing time with an opponent, players should indicate
      what time zone that they are in.  Players from different countries may
      want to express times in Greenwich Mean Time (GMT).</li>
        <li>Always keep all correspondence regarding the coordination of playing
            time with opponents until the end of each round.  This may be needed
            in case of disputes or unusual situations, which are covered above.</li>
      </ol>
      </font>
    </td>
  </tr>
