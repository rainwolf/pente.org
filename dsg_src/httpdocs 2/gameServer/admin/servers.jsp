...
<% for (Iterator it = resources.getServerData().iterator(); it.hasNext();) {
       ...
       String privateRoom = data.isPrivateServer() ?
        ...
        %>
   <tr>
     <td valign="top"><%= data.getServerId() %></td>
     <td valign="top"><%= data.getName() %></td>
     <td valign="top"><%= data.getPort() %></td>
<%
     String eventData = ""; 
...
%>   <td valign="top"><%= eventData %></td>
     <td valign="top"><%= data.isTournament() ? "Yes" : "No" %></td>
     <td valign="top"><%= privateRoom %></td>
