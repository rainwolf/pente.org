...
<div style="float:left;text-align:center;width:100%;" class="name"><%@include file="playerLink.jspf" %></div>
...
if (d.hasAvatar()) {
	...
	%>
    <a href="/gameServer/profile?viewName=<%= d.getName() %>"><img border="0" width="<%= width %>" src="/gameServer/avatar?name=<%= d.getName() %>" style="border:1px solid gray"></a>
<% } else { %>
