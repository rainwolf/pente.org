...
<tr bgcolor="#ffffff">
    ...
    <td><font size="-1"><%= ProfiledConnection.getQueryCount(ProfiledConnection.SELECT) %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td><font size="-1">Total time for all selects (ms)</font></td>
    <td><font size="-1"><%= ProfiledConnection.getTotalQueryTime(ProfiledConnection.SELECT) %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td><font size="-1">Average time for all selects (ms)</font></td>
    <td><font size="-1"><%= buildStringValue(ProfiledConnection.getAverageQueryTime(ProfiledConnection.SELECT),3) %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td><font size="-1">Selects per second</font></td>
    <td><font size="-1"><%= buildStringValue(ProfiledConnection.getQueriesPerSecond(ProfiledConnection.SELECT),3) %></font></td>
</tr>
<tr bgcolor="#ffffff">
...
<tr bgcolor="#ffffff">
    ...
    <td><font size="-1"><%= ProfiledConnection.getQueryCount(ProfiledConnection.INSERT) %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td><font size="-1">Total time for all inserts (ms)</font></td>
    <td><font size="-1"><%= ProfiledConnection.getTotalQueryTime(ProfiledConnection.INSERT) %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td><font size="-1">Average time for all inserts (ms)</font></td>
    <td><font size="-1"><%= buildStringValue(ProfiledConnection.getAverageQueryTime(ProfiledConnection.INSERT),3) %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td><font size="-1">Inserts per second</font></td>
    <td><font size="-1"><%= buildStringValue(ProfiledConnection.getQueriesPerSecond(ProfiledConnection.INSERT),3) %></font></td>
</tr>
<tr bgcolor="#ffffff">
...
<tr bgcolor="#ffffff">
    ...
    <td><font size="-1"><%= ProfiledConnection.getQueryCount(ProfiledConnection.UPDATE) %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td><font size="-1">Total time for all updates (ms)</font></td>
    <td><font size="-1"><%= ProfiledConnection.getTotalQueryTime(ProfiledConnection.UPDATE) %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td><font size="-1">Average time for all updates (ms)</font></td>
    <td><font size="-1"><%= buildStringValue(ProfiledConnection.getAverageQueryTime(ProfiledConnection.UPDATE),3) %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td><font size="-1">Updates per second</font></td>
    <td><font size="-1"><%= buildStringValue(ProfiledConnection.getQueriesPerSecond(ProfiledConnection.UPDATE),3) %></font></td>
</tr>
<tr bgcolor="#ffffff">
...
<tr bgcolor="#ffffff">
    ...
    <td><font size="-1"><%= ProfiledConnection.getQueryCount(ProfiledConnection.DELETE) %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td><font size="-1">Total time for all deletes (ms)</font></td>
    <td><font size="-1"><%= ProfiledConnection.getTotalQueryTime(ProfiledConnection.DELETE) %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td><font size="-1">Average time for all deletes (ms)</font></td>
    <td><font size="-1"><%= buildStringValue(ProfiledConnection.getAverageQueryTime(ProfiledConnection.DELETE),3) %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td><font size="-1">Deletes per second</font></td>
    <td><font size="-1"><%= buildStringValue(ProfiledConnection.getQueriesPerSecond(ProfiledConnection.DELETE),3) %></font></td>
</tr>
<tr bgcolor="#ffffff">
