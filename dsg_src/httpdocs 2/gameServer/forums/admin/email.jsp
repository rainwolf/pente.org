...
<ul>
    ...
    <tr>
        ...
        <td><input type="text" name="username" value="<%= (username!=null)?username:"" %>" size="40" maxlength="150"></td>
    </tr>
    <tr>
        <td><font size="-1">SMTP Password (Optional):</font></td>
        <td><input type="password" name="password" value="<%= (password!=null)?password:"" %>" size="40" maxlength="150"></td>
    </tr>
<%  if (isProfessional) { %>
    <tr>
...
<br>
<font size="-1"><b>Email Template Settings</b></font><p>
...
<ul>
    ...
    <tr>
        ...
        <td><input type="text" name="jiveURL" value="<%= (jiveURL!=null)?jiveURL:"" %>" size="40" maxlength="150"></td>
    </tr>
    </table>
</ul>
