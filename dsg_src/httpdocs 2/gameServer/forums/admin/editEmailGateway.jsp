...
<ul>
    ...
    <tr>
    	...
    	<td><input type="text" name="inboundHost" value="<% if (inboundHost != null) { %><%= inboundHost %><% } %>" size="30" maxlength="100"></td>
    ...
    <tr>
    	...
    	<td><input type="text" name="inboundUsername" value="<% if (inboundUsername != null) { %><%= inboundUsername %><% } %>" size="15" maxlength="100"></td>
    ...
    <tr>
    	...
    	<td><input type="text" name="inboundPassword" value="<% if (inboundPassword != null) { %><%= inboundPassword %><% } %>" size="15" maxlength="100"></td>
...
<ul>
    ...
    <tr>
    	<td><font size="-1">Host:</font></td>
    	<td><input type="text" name="outboundHost" value="<% if (outboundHost != null) { %><%= outboundHost %><% } %>" size="30" maxlength="100"></td>
    ...
    <tr>
    	...
    	<td><input type="text" name="fromAddress" value="<% if (fromAddress != null) { %><%= fromAddress %><% } %>" size="30" maxlength="100"></td>
    ...
    <tr>
    	...
    	<td><input type="text" name="replyToAddress" value="<% if (replyToAddress != null) { %><%= replyToAddress %><% } %>" size="30" maxlength="100"></td>
    ...
    <tr>
    	...
    	<td><input type="text" name="toAddress" value="<% if (toAddress != null) { %><%= toAddress %><% } %>" size="30" maxlength="100"></td>
...
<ul>
    ...
    <tr>
        ...
        <td><font size="-1"><input type="radio" name="deleteEnabled" value="true" <% if (deleteEnabled) { %>checked<% } %>>Enabled <input type="radio" name="deleteEnabled" value="false" <% if (!deleteEnabled) { %>checked<% } %>>Disabled</font></td>
    ...
    <tr>
        ...
        <td><textarea name="tempParentBody" cols="30" rows="5" wrap="virtual"><% if (tempParentBody != null) { %><%= tempParentBody %><% } %></textarea></td>
    ...
    <tr>
        ...
        <td><font size="-1"><input type="text" name="importAfter" value="<% if (importAfter != null) { %><%= importAfter%><% } %>" size="30" maxlength="75"> (in format dd/mm/yyyy)</font></td>
    ...
    <tr>
        ...
        <td><font size="-1"><input type="radio" name="debug" value="true" <% if (debug) { %>checked<% } %>>Enabled <input type="radio" name="debug" value="false" <% if (!debug) { %>checked<% } %>>Disabled</font></td>
...
<ul>
    ...
    <tr>
        <td><font size="-1">Username: </font></td>
        <td><input type="text" name="outboundUsername" value="<% if (outboundUsername != null) { %><%= outboundUsername %><% } %>" size="15" maxlength="100"></td>
    ...
    <tr>
        <td><font size="-1">Password: </font></td>
        <td><input type="text" name="outboundPassword" value="<% if (outboundPassword != null) { %><%= outboundPassword %><% } %>" size="15" maxlength="100"></td>
    ...
    <tr>
        ...
        <td><input type="text" name="organization" value="<% if (organization != null) { %><%= organization%><% } %>" size="30" maxlength="75"></td>
    ...
    <tr>
        ...
        <td><font size="-1"><input type="radio" name="fromPref" value="true" <% if (fromPref) { %>checked<% } %>>Yes <input type="radio" name="fromPref" value="false" <% if (!fromPref) { %>checked<% } %>>No</font></td>
    ...
    <tr>
        ...
        <td><font size="-1"><input type="radio" name="emailPref" value="true" <% if (emailPref) { %>checked<% } %>>Yes <input type="radio" name="emailPref" value="false" <% if (!emailPref) { %>checked<% } %>>No</font></td>
    ...
    <tr>
    	...
    	<td><font size="-1"><input type="radio" name="outboundAttach" value="true" <% if (outboundAttach) { %>checked<% } %>>Enabled <input type="radio" name="outboundAttach" value="false" <% if (!outboundAttach) { %>checked<% } %>>Disabled</font></td>
        <td><a href="#" onclick="helpwin('emailGateway','attachments');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    <% if (exportOnce) { %>
    <tr>
        <td><font size="-1">Export messages after: </font></td>
        <td><font size="-1"><input type="text" name="exportAfter" value="<% if (exportAfter != null) { %><%= exportAfter%><% } %>" size="30" maxlength="75"> (in format dd/mm/yyyy)</font></td>
    ...
    <tr>
        ...
        <td><font size="-1"><input type="radio" name="allowExportAgain" value="true" <% if (allowExportAgain) { %>checked<% } %>>Yes <input type="radio" name="allowExportAgain" value="false" <% if (!allowExportAgain) { %>checked<% } %>>No</font></td>
    ...
    <tr>
        ...
        <td><font size="-1"><input type="radio" name="updateMessageID" value="true" <% if (updateMessageID) { %>checked<% } %>>Yes <input type="radio" name="updateMessageID" value="false" <% if (!updateMessageID) { %>checked<% } %>>No</font></td>
