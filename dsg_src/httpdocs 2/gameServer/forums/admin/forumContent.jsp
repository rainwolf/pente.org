...
<%  if (showForumList) { %>
    ...
    <tr bgcolor="#ffffff">
        ...
        <td width="1%" nowrap><font size="-1"><%= JiveGlobals.formatDateTime(f.getModificationDate()) %></font></td>
    </tr>
    <%  } %>
    </table>
    </td></tr>
...
<%  } else { // showThreadList %>
    ...
    <%  } else { %>
        ...
        <tr bgcolor="#ffffff" id="r<%= id %>">
            ...
            <td nowrap><font size="-1"><%= JiveGlobals.formatDateTime(theThread.getModificationDate()) %></font></td>
            <td align="center"
