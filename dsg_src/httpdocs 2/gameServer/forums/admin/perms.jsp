...
<%  } else if (permGroup == CONTENT_GROUP) { %>
    ...
    <%  if (mode == CAT_MODE) { %>
        ...
        <b>Permission Summary for Category: <%= category.getName() %></b>

    <%  } else if (mode == FORUM_MODE) { %>

        <%  if (forum != null) { %>

            <b>Permission Summary for Forum: <%= forum.getName() %></b>
...
<ul>
    ...
    %>
        <td align="center"><table cellpadding="3" cellspacing="0" border="0"><tr><td><font size="-2" face="verdana"><b><%= header %></b></font></td></tr></table></td>
    <%  } %>
    </tr>
    <tr bgcolor="#ffffff">
    ...
    %>
        ...
        <%  } %>
            ...
            ><table cellpadding="3" cellspacing="0" border="0"><tr><td
            ><font size="-1"><input type="submit" value="Remove"></font></td></tr></table>
        </td>
        </form>
    <%  } // end for %>
    </tr>
...
<ul>
    <font size="-1">Use the form below to grant a permission to guests, all users, a specific user or a specific group.</font>
    <p>
    ...
    <ul>
        ...
        <tr>
            ...
            <td><font size="-1"><label for="<%= (i+1) %>"><%= permName %></label></font></td>
        </tr>
        <%  } // end for %>
        </table>
    </ul><p>
