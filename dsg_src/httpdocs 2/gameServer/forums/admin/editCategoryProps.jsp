...
<font size="-1">
Edit the extended properties of a category using the forms below.
</font>
...
<%  }
    while (properties.hasNext()) {
        ...
        propertyValue = category.getProperty(propertyName);
%>
<tr bgcolor="#ffffff">
    <td><font size="-1"><%= propertyName %></font></td>
    <td><font size="-1"><%= propertyValue %></font></td>
    <td align="center"><a href="editCategoryProps.jsp?cat=<%= categoryID %>&delete=true&propName=<%= propertyName %>"
