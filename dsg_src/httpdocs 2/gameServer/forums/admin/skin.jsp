...
%>
    ...
    <ul><li><font size="-1"><a href="skin.jsp?mode=fonts">Fonts</a>
...
<%  } else if ("fonts".equals(mode)) { %>
    ...
    <tr bgcolor="#ffffff">
        ...
        <td nowrap><font size="-1">Font List:</font></td><td><input type="text" size="25" name="fontFace" maxlength="100" value="<%= (fontFace!=null)?fontFace:"" %>"></td>
...
<%  }
    ...
    <tr><td>
        <input type="radio" name="useDefaultWelcomeText" value="true"<%= (("true".equals(useDefaultWelcomeText))?" checked":"") %> id="rb01">
        </td>
        <td>
            <font size="-1">
    ...
    <tr><td>
        <input type="radio" name="useDefaultWelcomeText" value="false"<%= (("true".equals(useDefaultWelcomeText))?"":" checked") %> id="rb02">
        </td>
        <td>
            <font size="-1">
...
<%  }
    ...
    <tr bgcolor="#ffffff">
        ...
        <td valign="top">
            ...
            <tr><td>
                <input type="radio" name="useDefaultHeaderImage" value="true"<%= ("true".equals(useDefaultHeaderImage)?" checked":"") %> id="rb01">
                </td>
                <td>
                    <font size="-1">
            ...
            <tr><td>
                <input type="radio" name="useDefaultHeaderImage" value="false"<%= ("true".equals(useDefaultHeaderImage)?"":" checked") %> id="rb02">
                </td>
                <td>
                    <font size="-1">
...
<%  }
    ...
    <p><b>Show "Last Post" Link:</b>
        ...
        <tr valign="top">
             <td>
                 <input type="radio" name="showLastPostLink" value="true"<%= ("true".equals(showLastPostLink))?" checked":"" %> id="rb10">
             </td>
             <td>
        ...
        <tr valign="top">
            <td>
                <input type="radio" name="showLastPostLink" value="false"<%= ("false".equals(showLastPostLink))?" checked":"" %> id="rb20">
            </td>
            <td>
    ...
    <p><b>New Account Creation Enabled:</b>
        ...
        <tr valign="top">
             <td>
                 <input type="radio" name="newAccountCreationEnabled" value="true"<%= ("true".equals(newAccountCreationEnabled))?" checked":"" %> id="rb7">
             </td>
             <td>
        ...
        <tr valign="top">
            <td>
                <input type="radio" name="newAccountCreationEnabled" value="false"<%= ("false".equals(newAccountCreationEnabled))?" checked":"" %> id="rb8">
            </td>
            <td>
    ...
    <p><b>Track IPs:</b>
        ...
        <tr valign="top">
            <td>
                <input type="radio" name="trackIP" value="false"<%= ("false".equals(trackIP))?" checked":"" %> id="rb4">
            </td>
            <td>
    ...
    <p><b>Allow Users To Choose Locale:</b>
        ...
        <tr valign="top">
             <td>
                 <input type="radio" name="usersChooseLocale" value="true"<%= ("true".equals(usersChooseLocale))?" checked":"" %> id="rb30">
             </td>
             <td>
        ...
        <tr valign="top">
            <td>
                <input type="radio" name="usersChooseLocale" value="false"<%= ("false".equals(usersChooseLocale))?" checked":"" %> id="rb40">
            </td>
            <td>
    ...
    <p><b>Read Tracking:</b>
        ...
        <tr valign="top">
             <td>
                 <input type="radio" name="readTracker.enabled" value="true"<%= ("true".equals(readTrackerEnabled))?" checked":"" %> id="rb511">
             </td>
             <td>
        ...
        <tr valign="top">
            <td>
                <input type="radio" name="readTracker.enabled" value="false"<%= (!"true".equals(readTrackerEnabled))?" checked":"" %> id="rb611">
            </td>
            <td>
