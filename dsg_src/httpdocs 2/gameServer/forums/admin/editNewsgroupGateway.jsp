...
<ul>
    ...
    <tr>
    	...
    	<td><input type="text" name="host" value="<% if (host != null) { %><%= host %><% } %>" size="30" maxlength="100"></td>
    ...
    <tr>
    	...
    	<td><input type="text" name="newsgroup" value="<% if (newsgroup != null) { %><%= newsgroup %><% } %>" size="30" maxlength="100"></td>
...
<ul>
    ...
    <tr>
        ...
        <td><input type="text" name="username" value="<% if (username != null) { %><%= username %><% } %>" size="15" maxlength="100"></td>
    ...
    <tr>
        ...
        <td><input type="text" name="password" value="<% if (password != null) { %><%= password %><% } %>" size="15" maxlength="100"></td>
    ...
    <tr>
    	...
    	<td><font size="-1"><input type="radio" name="attachments" value="true" <% if (attachments) { %>checked<% } %>>Enabled <input type="radio" name="attachments" value="false" <% if (!attachments) { %>checked<% } %>>Disabled</font></td>
